...
**Дата:** 22.07.2026 04:02  
**Путь:** `/tmp/gsc-learn/sqlalchemy`  
**Всего находок:** 1552  
**CRITICAL:** 129 | **HIGH:** 74 | **MEDIUM:** 795 | **LOW:** 553

## 📊 По детекторам

| Детектор | Находок |
|----------|--------|
| Python: assert in production | 648 |
...
| CRITICAL | ? | compiler.py | 5737 |  |
| CRITICAL | ? | compiler.py | 6441 |  |
...
| CRITICAL | ? | sqltypes.py | 1987 | Match:     ``pickle.dumps()`` to incoming objects, and ``pic |
...
---
*Сгенерировано GSC v0.6 · 2026-07-22T04:02:33.974772*