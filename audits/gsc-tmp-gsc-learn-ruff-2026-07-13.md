...
**Дата:** 13.07.2026 04:03  
**Путь:** `/tmp/gsc-learn/ruff`  
**Всего находок:** 4547  
**CRITICAL:** 253 | **HIGH:** 1524 | **MEDIUM:** 1145 | **LOW:** 1596

## 📊 По детекторам

| Детектор | Находок |
|----------|--------|
| Rust: .clone() in hot path | 1418 |
...
| HIGH | ? | lib.rs | 296 | Clone in performance-critical code — consider references |
| HIGH | ? | lib.rs | 311 | Clone in performance-critical code — consider references |
| HIGH | ? | lib.rs | 339 | Clone in performance-critical code — consider references |
| HIGH | ? | lib.rs | 340 | Clone in performance-critical code — consider references |
| HIGH | ? | lib.rs | 346 | Clone in performance-critical code — consider references |
...
| HIGH | ? | format_dev.rs | 579 | Clone in performance-critical code — consider references |
| HIGH | ? | format_dev.rs | 818 | Clone in performance-critical code — consider references |
...
| HIGH | ? | files.rs | 121 | Clone in performance-critical code — consider references |
| HIGH | ? | files.rs | 461 | Clone in performance-critical code — consider references |
| HIGH | ? | files.rs | 777 | Clone in performance-critical code — consider references |
...
| HIGH | ? | memory_fs.rs | 582 | Clone in performance-critical code — consider references |
| HIGH | ? | memory_fs.rs | 696 | Clone in performance-critical code — consider references |
| HIGH | ? | os.rs | 219 | Clone in performance-critical code — consider references |
| HIGH | ? | os.rs | 237 | Clone in performance-critical code — consider references |
| HIGH | ? | os.rs | 433 | Clone in performance-critical code — consider references |
| HIGH | ? | os.rs | 443 | Clone in performance-critical code — consider references |
...
| HIGH | ? | metadata.rs | 83 | Clone in performance-critical code — consider references |
| HIGH | ? | metadata.rs | 86 | Clone in performance-critical code — consider references |
| HIGH | ? | metadata.rs | 187 | Clone in performance-critical code — consider references |
| HIGH | ? | metadata.rs | 206 | Clone in performance-critical code — consider references |
| HIGH | ? | metadata.rs | 426 | Clone in performance-critical code — consider references |
| HIGH | ? | options.rs | 190 | Clone in performance-critical code — consider references |
| HIGH | ? | options.rs | 558 | Clone in performance-critical code — consider references |
| HIGH | ? | options.rs | 664 | Clone in performance-critical code — consider references |
| HIGH | ? | options.rs | 665 | Clone in performance-critical code — consider references |
| HIGH | ? | options.rs | 1987 | Clone in performance-critical code — consider references |
| HIGH | ? | options.rs | 1996 | Clone in performance-critical code — consider references |
| HIGH | ? | options.rs | 2004 | Clone in performance-critical code — consider references |
| HIGH | ? | options.rs | 2005 | Clone in performance-critical code — consider references |
| HIGH | ? | options.rs | 2103 | Clone in performance-critical code — consider references |
| HIGH | ? | options.rs | 2125 | Clone in performance-critical code — consider references |
| HIGH | ? | options.rs | 2245 | Clone in performance-critical code — consider references |
| HIGH | ? | options.rs | 2250 | Clone in performance-critical code — consider references |
| HIGH | ? | settings.rs | 49 | Clone in performance-critical code — consider references |
| HIGH | ? | settings.rs | 185 | Clone in performance-critical code — consider references |
| HIGH | ? | settings.rs | 188 | Clone in performance-critical code — consider references |
| HIGH | ? | settings.rs | 196 | Clone in performance-critical code — consider references |
| HIGH | ? | settings.rs | 197 | Clone in performance-critical code — consider references |
| HIGH | ? | pyproject.rs | 80 | Clone in performance-critical code — consider references |
| HIGH | ? | pyproject.rs | 130 | Clone in performance-critical code — consider references |
...
| HIGH | ? | ignore.rs | 352 | Clone in performance-critical code — consider references |
| HIGH | ? | ignore.rs | 368 | Clone in performance-critical code — consider references |
| HIGH | ? | changes.rs | 138 | Clone in performance-critical code — consider references |
| HIGH | ? | changes.rs | 168 | Clone in performance-critical code — consider references |
| HIGH | ? | changes.rs | 192 | Clone in performance-critical code — consider references |
| HIGH | ? | changes.rs | 193 | Clone in performance-critical code — consider references |
...
| HIGH | ? | db.rs | 556 | Clone in performance-critical code — consider references |
| HIGH | ? | db.rs | 602 | Clone in performance-critical code — consider references |
| HIGH | ? | db.rs | 659 | Clone in performance-critical code — consider references |
| HIGH | ? | db.rs | 666 | Clone in performance-critical code — consider references |
| HIGH | ? | db.rs | 790 | Clone in performance-critical code — consider references |
| HIGH | ? | db.rs | 801 | Clone in performance-critical code — consider references |
...
| HIGH | ? | lib.rs | 207 | Clone in performance-critical code — consider references |
| HIGH | ? | lib.rs | 658 | Clone in performance-critical code — consider references |
| HIGH | ? | lib.rs | 939 | Clone in performance-critical code — consider references |
...
| HIGH | ? | google.rs | 200 | Clone in performance-critical code — consider references |
| HIGH | ? | completion.rs | 481 | Clone in performance-critical code — consider references |
| HIGH | ? | completion.rs | 2059 | Clone in performance-critical code — consider references |
| HIGH | ? | completion.rs | 11003 | Clone in performance-critical code — consider references |
...
| HIGH | ? | inlay_hints.rs | 738 | Clone in performance-critical code — consider references |
| HIGH | ? | inlay_hints.rs | 880 | Clone in performance-critical code — consider references |
| HIGH | ? | inlay_hints.rs | 8516 | Clone in performance-critical code — consider references |
| HIGH | ? | inlay_hints.rs | 8518 | Clone in performance-critical code — consider references |
...
| HIGH | ? | lib.rs | 663 | Clone in performance-critical code — consider references |
...
| HIGH | ? | client.rs | 155 | Clone in performance-critical code — consider references |
| HIGH | ? | client.rs | 157 | Clone in performance-critical code — consider references |
...
| HIGH | ? | semantic_model.rs | 518 | Clone in performance-critical code — consider references |
| HIGH | ? | types.rs | 2749 | Clone in performance-critical code — consider references |
| HIGH | ? | types.rs | 2752 | Clone in performance-critical code — consider references |
| HIGH | ? | types.rs | 4034 | Clone in performance-critical code — consider references |
| HIGH | ? | types.rs | 4265 | Clone in performance-critical code — consider references |
| HIGH | ? | types.rs | 6106 | Clone in performance-critical code — consider references |
| HIGH | ? | types.rs | 7880 | Clone in performance-critical code — consider references |
| HIGH | ? | types.rs | 8615 | Clone in performance-critical code — consider references |
...
| HIGH | ? | fixes.rs | 1512 | Clone in performance-critical code — consider references |
| HIGH | ? | pydantic.rs | 256 | Clone in performance-critical code — consider references |
| HIGH | ? | diagnostic.rs | 1605 | Clone in performance-critical code — consider references |
| HIGH | ? | diagnostic.rs | 1817 | Clone in performance-critical code — consider references |
| HIGH | ? | diagnostic.rs | 1818 | Clone in performance-critical code — consider references |
| HIGH | ? | diagnostic.rs | 1886 | Clone in performance-critical code — consider references |
| HIGH | ? | diagnostic.rs | 2068 | Clone in performance-critical code — consider references |
| HIGH | ? | diagnostic.rs | 2198 | Clone in performance-critical code — consider references |
| HIGH | ? | diagnostic.rs | 3820 | Clone in performance-critical code — consider references |
| HIGH | ? | diagnostic.rs | 3828 | Clone in performance-critical code — consider references |
| HIGH | ? | diagnostic.rs | 4161 | Clone in performance-critical code — consider references |
| HIGH | ? | diagnostic.rs | 4168 | Clone in performance-critical code — consider references |
| HIGH | ? | diagnostic.rs | 4174 | Clone in performance-critical code — consider references |
| HIGH | ? | diagnostic.rs | 4180 | Clone in performance-critical code — consider references |
| HIGH | ? | diagnostic.rs | 4181 | Clone in performance-critical code — consider references |
| HIGH | ? | diagnostic.rs | 4217 | Clone in performance-critical code — consider references |
| HIGH | ? | diagnostic.rs | 4234 | Clone in performance-critical code — consider references |
| HIGH | ? | diagnostic.rs | 4318 | Clone in performance-critical code — consider references |
| HIGH | ? | diagnostic.rs | 4324 | Clone in performance-critical code — consider references |
| HIGH | ? | diagnostic.rs | 4330 | Clone in performance-critical code — consider references |
| HIGH | ? | diagnostic.rs | 4335 | Clone in performance-critical code — consider references |
| HIGH | ? | diagnostic.rs | 4336 | Clone in performance-critical code — consider references |
| HIGH | ? | arguments.rs | 263 | Clone in performance-critical code — consider references |
| HIGH | ? | arguments.rs | 386 | Clone in performance-critical code — consider references |
| HIGH | ? | bind.rs | 244 | Clone in performance-critical code — consider references |
| HIGH | ? | bind.rs | 3114 | Clone in performance-critical code — consider references |
| HIGH | ? | bind.rs | 5899 | Clone in performance-critical code — consider references |
| HIGH | ? | bind.rs | 6477 | Clone in performance-critical code — consider references |
| HIGH | ? | bind.rs | 6572 | Clone in performance-critical code — consider references |
| HIGH | ? | bind.rs | 6573 | Clone in performance-critical code — consider references |
| HIGH | ? | bind.rs | 6574 | Clone in performance-critical code — consider references |
| HIGH | ? | bind.rs | 7196 | Clone in performance-critical code — consider references |
| HIGH | ? | constructor.rs | 349 | Clone in performance-critical code — consider references |
...
| HIGH | ? | signatures.rs | 198 | Clone in performance-critical code — consider references |
| HIGH | ? | signatures.rs | 218 | Clone in performance-critical code — consider references |
| HIGH | ? | signatures.rs | 244 | Clone in performance-critical code — consider references |
| HIGH | ? | signatures.rs | 765 | Clone in performance-critical code — consider references |
| HIGH | ? | signatures.rs | 828 | Clone in performance-critical code — consider references |
| HIGH | ? | signatures.rs | 955 | Clone in performance-critical code — consider references |
| HIGH | ? | signatures.rs | 1063 | Clone in performance-critical code — consider references |
| HIGH | ? | signatures.rs | 1115 | Clone in performance-critical code — consider references |
| HIGH | ? | signatures.rs | 1133 | Clone in performance-critical code — consider references |
| HIGH | ? | signatures.rs | 1134 | Clone in performance-critical code — consider references |
| HIGH | ? | signatures.rs | 1265 | Clone in performance-critical code — consider references |
| HIGH | ? | signatures.rs | 1266 | Clone in performance-critical code — consider references |
| HIGH | ? | signatures.rs | 1340 | Clone in performance-critical code — consider references |
| HIGH | ? | signatures.rs | 1578 | Clone in performance-critical code — consider references |
| HIGH | ? | signatures.rs | 1630 | Clone in performance-critical code — consider references |
| HIGH | ? | signatures.rs | 1858 | Clone in performance-critical code — consider references |
| HIGH | ? | signatures.rs | 1902 | Clone in performance-critical code — consider references |
| HIGH | ? | signatures.rs | 2121 | Clone in performance-critical code — consider references |
| HIGH | ? | signatures.rs | 2122 | Clone in performance-critical code — consider references |
| HIGH | ? | signatures.rs | 2157 | Clone in performance-critical code — consider references |
| HIGH | ? | signatures.rs | 2182 | Clone in performance-critical code — consider references |
| HIGH | ? | signatures.rs | 2221 | Clone in performance-critical code — consider references |
| HIGH | ? | signatures.rs | 2385 | Clone in performance-critical code — consider references |
| HIGH | ? | signatures.rs | 2846 | Clone in performance-critical code — consider references |
| HIGH | ? | signatures.rs | 2847 | Clone in performance-critical code — consider references |
| HIGH | ? | signatures.rs | 2942 | Clone in performance-critical code — consider references |
| HIGH | ? | signatures.rs | 2943 | Clone in performance-critical code — consider references |
| HIGH | ? | signatures.rs | 2957 | Clone in performance-critical code — consider references |
| HIGH | ? | signatures.rs | 3242 | Clone in performance-critical code — consider references |
| HIGH | ? | signatures.rs | 3253 | Clone in performance-critical code — consider references |
| HIGH | ? | signatures.rs | 3372 | Clone in performance-critical code — consider references |
| HIGH | ? | signatures.rs | 3393 | Clone in performance-critical code — consider references |
| HIGH | ? | signatures.rs | 3680 | Clone in performance-critical code — consider references |
| HIGH | ? | signatures.rs | 3712 | Clone in performance-critical code — consider references |
| HIGH | ? | signatures.rs | 3724 | Clone in performance-critical code — consider references |
| HIGH | ? | signatures.rs | 3735 | Clone in performance-critical code — consider references |
| HIGH | ? | signatures.rs | 3747 | Clone in performance-critical code — consider references |
| HIGH | ? | signatures.rs | 3890 | Clone in performance-critical code — consider references |
| HIGH | ? | signatures.rs | 3893 | Clone in performance-critical code — consider references |
| HIGH | ? | signatures.rs | 3897 | Clone in performance-critical code — consider references |
| HIGH | ? | signatures.rs | 3900 | Clone in performance-critical code — consider references |
| HIGH | ? | signatures.rs | 3904 | Clone in performance-critical code — consider references |
| HIGH | ? | signatures.rs | 3909 | Clone in performance-critical code — consider references |
| HIGH | ? | signatures.rs | 3913 | Clone in performance-critical code — consider references |
| HIGH | ? | signatures.rs | 3957 | Clone in performance-critical code — consider references |
| HIGH | ? | signatures.rs | 4187 | Clone in performance-critical code — consider references |
| HIGH | ? | signatures.rs | 4199 | Clone in performance-critical code — consider references |
| HIGH | ? | signatures.rs | 4213 | Clone in performance-critical code — consider references |
| HIGH | ? | signatures.rs | 4223 | Clone in performance-critical code — consider references |
| HIGH | ? | signatures.rs | 4225 | Clone in performance-critical code — consider references |
| HIGH | ? | signatures.rs | 4402 | Clone in performance-critical code — consider references |
| HIGH | ? | signatures.rs | 4405 | Clone in performance-critical code — consider references |
| HIGH | ? | signatures.rs | 4476 | Clone in performance-critical code — consider references |
| HIGH | ? | signatures.rs | 4486 | Clone in performance-critical code — consider references |
| HIGH | ? | signatures.rs | 4496 | Clone in performance-critical code — consider references |
| HIGH | ? | signatures.rs | 4502 | Clone in performance-critical code — consider references |
| HIGH | ? | signatures.rs | 4526 | Clone in performance-critical code — consider references |
| HIGH | ? | signatures.rs | 4530 | Clone in performance-critical code — consider references |
| HIGH | ? | signatures.rs | 4534 | Clone in performance-critical code — consider references |
| HIGH | ? | signatures.rs | 4536 | Clone in performance-critical code — consider references |
| HIGH | ? | class.rs | 1345 | Clone in performance-critical code — consider references |
| HIGH | ? | class.rs | 2169 | Clone in performance-critical code — consider references |
| HIGH | ? | relation_error.rs | 24 | Clone in performance-critical code — consider references |
| HIGH | ? | ide_support.rs | 602 | Clone in performance-critical code — consider references |
| HIGH | ? | ide_support.rs | 705 | Clone in performance-critical code — consider references |
| HIGH | ? | ide_support.rs | 809 | Clone in performance-critical code — consider references |
| HIGH | ? | ide_support.rs | 2086 | Clone in performance-critical code — consider references |
| HIGH | ? | known_instance.rs | 680 | Clone in performance-critical code — consider references |
| HIGH | ? | known_instance.rs | 714 | Clone in performance-critical code — consider references |
| HIGH | ? | class_base.rs | 479 | Clone in performance-critical code — consider references |
| HIGH | ? | overrides.rs | 483 | Clone in performance-critical code — consider references |
| HIGH | ? | overrides.rs | 747 | Clone in performance-critical code — consider references |
| HIGH | ? | overrides.rs | 1444 | Clone in performance-critical code — consider references |
| HIGH | ? | relation.rs | 848 | Clone in performance-critical code — consider references |
| HIGH | ? | match_pattern.rs | 849 | Clone in performance-critical code — consider references |
| HIGH | ? | match_pattern.rs | 860 | Clone in performance-critical code — consider references |
| HIGH | ? | callable.rs | 164 | Clone in performance-critical code — consider references |
| HIGH | ? | callable.rs | 185 | Clone in performance-critical code — consider references |
| HIGH | ? | callable.rs | 725 | Clone in performance-critical code — consider references |
| HIGH | ? | callable.rs | 726 | Clone in performance-critical code — consider references |
...
| HIGH | ? | static_class.rs | 820 | Clone in performance-critical code — consider references |
| HIGH | ? | static_class.rs | 831 | Clone in performance-critical code — consider references |
| HIGH | ? | static_class.rs | 838 | Clone in performance-critical code — consider references |
| HIGH | ? | static_class.rs | 1058 | Clone in performance-critical code — consider references |
| HIGH | ? | static_class.rs | 1075 | Clone in performance-critical code — consider references |
| HIGH | ? | function.rs | 206 | Clone in performance-critical code — consider references |
| HIGH | ? | function.rs | 226 | Clone in performance-critical code — consider references |
| HIGH | ? | function.rs | 237 | Clone in performance-critical code — consider references |
...
| HIGH | ? | type_call.rs | 168 | Clone in performance-critical code — consider references |
| HIGH | ? | type_call.rs | 246 | Clone in performance-critical code — consider references |
...
| HIGH | ? | named_tuple.rs | 533 | Clone in performance-critical code — consider references |
| HIGH | ? | named_tuple.rs | 682 | Clone in performance-critical code — consider references |
| HIGH | ? | typevar.rs | 121 | Clone in performance-critical code — consider references |
| HIGH | ? | builder.rs | 523 | Clone in performance-critical code — consider references |
| HIGH | ? | builder.rs | 597 | Clone in performance-critical code — consider references |
| HIGH | ? | builder.rs | 627 | Clone in performance-critical code — consider references |
| HIGH | ? | builder.rs | 4950 | Clone in performance-critical code — consider references |
| HIGH | ? | builder.rs | 4955 | Clone in performance-critical code — consider references |
| HIGH | ? | builder.rs | 5089 | Clone in performance-critical code — consider references |
| HIGH | ? | builder.rs | 5609 | Clone in performance-critical code — consider references |
| HIGH | ? | builder.rs | 6533 | Clone in performance-critical code — consider references |
| HIGH | ? | builder.rs | 6641 | Clone in performance-critical code — consider references |
| HIGH | ? | builder.rs | 6665 | Clone in performance-critical code — consider references |
| HIGH | ? | builder.rs | 7363 | Clone in performance-critical code — consider references |
| HIGH | ? | builder.rs | 7380 | Clone in performance-critical code — consider references |
| HIGH | ? | builder.rs | 7396 | Clone in performance-critical code — consider references |
| HIGH | ? | builder.rs | 7401 | Clone in performance-critical code — consider references |
| HIGH | ? | builder.rs | 7412 | Clone in performance-critical code — consider references |
| HIGH | ? | builder.rs | 7507 | Clone in performance-critical code — consider references |
| HIGH | ? | builder.rs | 8521 | Clone in performance-critical code — consider references |
| HIGH | ? | builder.rs | 9287 | Clone in performance-critical code — consider references |
| HIGH | ? | builder.rs | 9438 | Clone in performance-critical code — consider references |
| HIGH | ? | builder.rs | 10704 | Clone in performance-critical code — consider references |
| HIGH | ? | builder.rs | 11258 | Clone in performance-critical code — consider references |
...
| HIGH | ? | display.rs | 1084 | Clone in performance-critical code — consider references |
| HIGH | ? | display.rs | 1087 | Clone in performance-critical code — consider references |
| HIGH | ? | display.rs | 1090 | Clone in performance-critical code — consider references |
| HIGH | ? | display.rs | 1103 | Clone in performance-critical code — consider references |
| HIGH | ? | display.rs | 1132 | Clone in performance-critical code — consider references |
| HIGH | ? | display.rs | 1279 | Clone in performance-critical code — consider references |
| HIGH | ? | display.rs | 1282 | Clone in performance-critical code — consider references |
| HIGH | ? | display.rs | 1291 | Clone in performance-critical code — consider references |
| HIGH | ? | display.rs | 1297 | Clone in performance-critical code — consider references |
| HIGH | ? | display.rs | 1311 | Clone in performance-critical code — consider references |
| HIGH | ? | display.rs | 1334 | Clone in performance-critical code — consider references |
| HIGH | ? | display.rs | 1351 | Clone in performance-critical code — consider references |
| HIGH | ? | display.rs | 1380 | Clone in performance-critical code — consider references |
| HIGH | ? | display.rs | 1386 | Clone in performance-critical code — consider references |
| HIGH | ? | display.rs | 1389 | Clone in performance-critical code — consider references |
| HIGH | ? | display.rs | 1412 | Clone in performance-critical code — consider references |
| HIGH | ? | display.rs | 1417 | Clone in performance-critical code — consider references |
| HIGH | ? | display.rs | 1593 | Clone in performance-critical code — consider references |
| HIGH | ? | display.rs | 1648 | Clone in performance-critical code — consider references |
| HIGH | ? | display.rs | 1649 | Clone in performance-critical code — consider references |
| HIGH | ? | display.rs | 1662 | Clone in performance-critical code — consider references |
| HIGH | ? | display.rs | 1684 | Clone in performance-critical code — consider references |
| HIGH | ? | display.rs | 1732 | Clone in performance-critical code — consider references |
| HIGH | ? | display.rs | 1749 | Clone in performance-critical code — consider references |
| HIGH | ? | display.rs | 1755 | Clone in performance-critical code — consider references |
| HIGH | ? | display.rs | 1814 | Clone in performance-critical code — consider references |
| HIGH | ? | display.rs | 1955 | Clone in performance-critical code — consider references |
| HIGH | ? | display.rs | 1978 | Clone in performance-critical code — consider references |
| HIGH | ? | display.rs | 2057 | Clone in performance-critical code — consider references |
| HIGH | ? | display.rs | 2064 | Clone in performance-critical code — consider references |
| HIGH | ? | display.rs | 2079 | Clone in performance-critical code — consider references |
| HIGH | ? | display.rs | 2190 | Clone in performance-critical code — consider references |
| HIGH | ? | display.rs | 2199 | Clone in performance-critical code — consider references |
| HIGH | ? | display.rs | 2377 | Clone in performance-critical code — consider references |
| HIGH | ? | display.rs | 2432 | Clone in performance-critical code — consider references |
| HIGH | ? | display.rs | 2455 | Clone in performance-critical code — consider references |
| HIGH | ? | display.rs | 2481 | Clone in performance-critical code — consider references |
| HIGH | ? | display.rs | 2918 | Clone in performance-critical code — consider references |
| HIGH | ? | display.rs | 2958 | Clone in performance-critical code — consider references |
| HIGH | ? | display.rs | 2973 | Clone in performance-critical code — consider references |
| HIGH | ? | constraints.rs | 284 | Clone in performance-critical code — consider references |
| HIGH | ? | constraints.rs | 3104 | Clone in performance-critical code — consider references |
| HIGH | ? | constraints.rs | 6667 | Clone in performance-critical code — consider references |
| HIGH | ? | constraints.rs | 6668 | Clone in performance-critical code — consider references |
| HIGH | ? | constraints.rs | 6682 | Clone in performance-critical code — consider references |
| HIGH | ? | constraints.rs | 6683 | Clone in performance-critical code — consider references |
| HIGH | ? | static_literal.rs | 1366 | Clone in performance-critical code — consider references |
| HIGH | ? | static_literal.rs | 1554 | Clone in performance-critical code — consider references |
| HIGH | ? | static_literal.rs | 1565 | Clone in performance-critical code — consider references |
| HIGH | ? | static_literal.rs | 1572 | Clone in performance-critical code — consider references |
| HIGH | ? | static_literal.rs | 1656 | Clone in performance-critical code — consider references |
| HIGH | ? | static_literal.rs | 2022 | Clone in performance-critical code — consider references |
| HIGH | ? | static_literal.rs | 2027 | Clone in performance-critical code — consider references |
| HIGH | ? | static_literal.rs | 2059 | Clone in performance-critical code — consider references |
| HIGH | ? | static_literal.rs | 2170 | Clone in performance-critical code — consider references |
| HIGH | ? | static_literal.rs | 2197 | Clone in performance-critical code — consider references |
| HIGH | ? | static_literal.rs | 2317 | Clone in performance-critical code — consider references |
...
| HIGH | ? | enum_literal.rs | 251 | Clone in performance-critical code — consider references |
...
| HIGH | ? | tuple.rs | 679 | Clone in performance-critical code — consider references |
| HIGH | ? | tuple.rs | 2595 | Clone in performance-critical code — consider references |
| HIGH | ? | tuple.rs | 2622 | Clone in performance-critical code — consider references |
| HIGH | ? | generics.rs | 1028 | Clone in performance-critical code — consider references |
| HIGH | ? | equality.rs | 795 | Clone in performance-critical code — consider references |
| HIGH | ? | function.rs | 699 | Clone in performance-critical code — consider references |
| HIGH | ? | function.rs | 715 | Clone in performance-critical code — consider references |
...
| HIGH | ? | function.rs | 1090 | Clone in performance-critical code — consider references |
| HIGH | ? | function.rs | 2528 | Clone in performance-critical code — consider references |
| HIGH | ? | builder.rs | 1264 | Clone in performance-critical code — consider references |
| HIGH | ? | builder.rs | 1338 | Clone in performance-critical code — consider references |
| HIGH | ? | builder.rs | 1339 | Clone in performance-critical code — consider references |
| HIGH | ? | builder.rs | 1347 | Clone in performance-critical code — consider references |
| HIGH | ? | builder.rs | 1348 | Clone in performance-critical code — consider references |
| HIGH | ? | builder.rs | 1446 | Clone in performance-critical code — consider references |
| HIGH | ? | cyclic.rs | 86 | Clone in performance-critical code — consider references |
| HIGH | ? | cyclic.rs | 90 | Clone in performance-critical code — consider references |
| HIGH | ? | cyclic.rs | 93 | Clone in performance-critical code — consider references |
| HIGH | ? | cyclic.rs | 99 | Clone in performance-critical code — consider references |
| HIGH | ? | cyclic.rs | 286 | Clone in performance-critical code — consider references |
| HIGH | ? | narrow.rs | 721 | Clone in performance-critical code — consider references |
| HIGH | ? | narrow.rs | 722 | Clone in performance-critical code — consider references |
| HIGH | ? | narrow.rs | 733 | Clone in performance-critical code — consider references |
| HIGH | ? | narrow.rs | 734 | Clone in performance-critical code — consider references |
| HIGH | ? | narrow.rs | 844 | Clone in performance-critical code — consider references |
| HIGH | ? | narrow.rs | 1872 | Clone in performance-critical code — consider references |
| HIGH | ? | narrow.rs | 1881 | Clone in performance-critical code — consider references |
| HIGH | ? | narrow.rs | 3343 | Clone in performance-critical code — consider references |
| HIGH | ? | narrow.rs | 3486 | Clone in performance-critical code — consider references |
| HIGH | ? | narrow.rs | 3508 | Clone in performance-critical code — consider references |
| HIGH | ? | narrow.rs | 3845 | Clone in performance-critical code — consider references |
| HIGH | ? | enums.rs | 37 | Clone in performance-critical code — consider references |
| HIGH | ? | enums.rs | 414 | Clone in performance-critical code — consider references |
| HIGH | ? | enums.rs | 449 | Clone in performance-critical code — consider references |
| HIGH | ? | enums.rs | 779 | Clone in performance-critical code — consider references |
| HIGH | ? | enums.rs | 810 | Clone in performance-critical code — consider references |
| HIGH | ? | enums.rs | 812 | Clone in performance-critical code — consider references |
| HIGH | ? | bound_super.rs | 926 | Clone in performance-critical code — consider references |
...
| HIGH | ? | set_theoretic.rs | 792 | Clone in performance-critical code — consider references |
| HIGH | ? | set_theoretic.rs | 801 | Clone in performance-critical code — consider references |
...
| HIGH | ? | list_members.rs | 416 | Clone in performance-critical code — consider references |
| HIGH | ? | list_members.rs | 425 | Clone in performance-critical code — consider references |
| HIGH | ? | protocol_class.rs | 256 | Clone in performance-critical code — consider references |
| HIGH | ? | protocol_class.rs | 258 | Clone in performance-critical code — consider references |
| HIGH | ? | protocol_class.rs | 368 | Clone in performance-critical code — consider references |
| HIGH | ? | protocol_class.rs | 389 | Clone in performance-critical code — consider references |
| HIGH | ? | protocol_class.rs | 2104 | Clone in performance-critical code — consider references |
...
| HIGH | ? | db.rs | 65 | Clone in performance-critical code — consider references |
| HIGH | ? | db.rs | 73 | Clone in performance-critical code — consider references |
| HIGH | ? | db.rs | 160 | Clone in performance-critical code — consider references |
...
| HIGH | ? | reachability.rs | 566 | Clone in performance-critical code — consider references |
| HIGH | ? | reachability.rs | 926 | Clone in performance-critical code — consider references |
| HIGH | ? | reachability.rs | 933 | Clone in performance-critical code — consider references |
| HIGH | ? | reachability.rs | 1084 | Clone in performance-critical code — consider references |
| HIGH | ? | reachability.rs | 1097 | Clone in performance-critical code — consider references |
| HIGH | ? | reachability.rs | 1100 | Clone in performance-critical code — consider references |
| HIGH | ? | lib.rs | 190 | Clone in performance-critical code — consider references |
...
| HIGH | ? | ty.rs | 1720 | Clone in performance-critical code — consider references |
...
| HIGH | ? | use_def.rs | 1769 | Clone in performance-critical code — consider references |
| HIGH | ? | use_def.rs | 1770 | Clone in performance-critical code — consider references |
| HIGH | ? | use_def.rs | 1978 | Clone in performance-critical code — consider references |
| HIGH | ? | use_def.rs | 1986 | Clone in performance-critical code — consider references |
| HIGH | ? | use_def.rs | 2140 | Clone in performance-critical code — consider references |
| HIGH | ? | use_def.rs | 2233 | Clone in performance-critical code — consider references |
| HIGH | ? | use_def.rs | 2251 | Clone in performance-critical code — consider references |
| HIGH | ? | use_def.rs | 2359 | Clone in performance-critical code — consider references |
| HIGH | ? | use_def.rs | 2377 | Clone in performance-critical code — consider references |
| HIGH | ? | use_def.rs | 2418 | Clone in performance-critical code — consider references |
| HIGH | ? | use_def.rs | 2419 | Clone in performance-critical code — consider references |
| HIGH | ? | use_def.rs | 2463 | Clone in performance-critical code — consider references |
| HIGH | ? | use_def.rs | 2780 | Clone in performance-critical code — consider references |
...
| HIGH | ? | member.rs | 224 | Clone in performance-critical code — consider references |
...
| HIGH | ? | builder.rs | 653 | Clone in performance-critical code — consider references |
| HIGH | ? | builder.rs | 693 | Clone in performance-critical code — consider references |
| HIGH | ? | builder.rs | 706 | Clone in performance-critical code — consider references |
| HIGH | ? | builder.rs | 1006 | Clone in performance-critical code — consider references |
| HIGH | ? | builder.rs | 1061 | Clone in performance-critical code — consider references |
| HIGH | ? | builder.rs | 1172 | Clone in performance-critical code — consider references |
| HIGH | ? | builder.rs | 1655 | Clone in performance-critical code — consider references |
| HIGH | ? | builder.rs | 1673 | Clone in performance-critical code — consider references |
| HIGH | ? | builder.rs | 1678 | Clone in performance-critical code — consider references |
| HIGH | ? | builder.rs | 1791 | Clone in performance-critical code — consider references |
| HIGH | ? | builder.rs | 2089 | Clone in performance-critical code — consider references |
| HIGH | ? | builder.rs | 2107 | Clone in performance-critical code — consider references |
| HIGH | ? | builder.rs | 2133 | Clone in performance-critical code — consider references |
| HIGH | ? | builder.rs | 2136 | Clone in performance-critical code — consider references |
| HIGH | ? | builder.rs | 2347 | Clone in performance-critical code — consider references |
| HIGH | ? | builder.rs | 2470 | Clone in performance-critical code — consider references |
| HIGH | ? | builder.rs | 2480 | Clone in performance-critical code — consider references |
| HIGH | ? | builder.rs | 2492 | Clone in performance-critical code — consider references |
| HIGH | ? | builder.rs | 2519 | Clone in performance-critical code — consider references |
| HIGH | ? | builder.rs | 2538 | Clone in performance-critical code — consider references |
| HIGH | ? | builder.rs | 2559 | Clone in performance-critical code — consider references |
| HIGH | ? | builder.rs | 2813 | Clone in performance-critical code — consider references |
| HIGH | ? | builder.rs | 2855 | Clone in performance-critical code — consider references |
| HIGH | ? | builder.rs | 2863 | Clone in performance-critical code — consider references |
| HIGH | ? | builder.rs | 2890 | Clone in performance-critical code — consider references |
| HIGH | ? | builder.rs | 3033 | Clone in performance-critical code — consider references |
| HIGH | ? | builder.rs | 3104 | Clone in performance-critical code — consider references |
| HIGH | ? | builder.rs | 3213 | Clone in performance-critical code — consider references |
| HIGH | ? | builder.rs | 3776 | Clone in performance-critical code — consider references |
| HIGH | ? | builder.rs | 3870 | Clone in performance-critical code — consider references |
| HIGH | ? | builder.rs | 3896 | Clone in performance-critical code — consider references |
| HIGH | ? | builder.rs | 3983 | Clone in performance-critical code — consider references |
| HIGH | ? | builder.rs | 4026 | Clone in performance-critical code — consider references |
| HIGH | ? | builder.rs | 4038 | Clone in performance-critical code — consider references |
| HIGH | ? | builder.rs | 4077 | Clone in performance-critical code — consider references |
| HIGH | ? | builder.rs | 4673 | Clone in performance-critical code — consider references |
| HIGH | ? | builder.rs | 4694 | Clone in performance-critical code — consider references |
...
| HIGH | ? | check.rs | 129 | Clone in performance-critical code — consider references |
...
| HIGH | ? | diagnostics.rs | 374 | Clone in performance-critical code — consider references |
| HIGH | ? | tokens.rs | 380 | Clone in performance-critical code — consider references |
| HIGH | ? | helpers.rs | 1714 | Clone in performance-critical code — consider references |
| HIGH | ? | helpers.rs | 1734 | Clone in performance-critical code — consider references |
| HIGH | ? | helpers.rs | 1944 | Clone in performance-critical code — consider references |
| HIGH | ? | helpers.rs | 1952 | Clone in performance-critical code — consider references |
| HIGH | ? | helpers.rs | 1956 | Clone in performance-critical code — consider references |
| HIGH | ? | helpers.rs | 1962 | Clone in performance-critical code — consider references |
| HIGH | ? | helpers.rs | 1967 | Clone in performance-critical code — consider references |
| HIGH | ? | helpers.rs | 1996 | Clone in performance-critical code — consider references |
| HIGH | ? | helpers.rs | 2014 | Clone in performance-critical code — consider references |
| HIGH | ? | helpers.rs | 2052 | Clone in performance-critical code — consider references |
| HIGH | ? | helpers.rs | 2089 | Clone in performance-critical code — consider references |
...
| HIGH | ? | name.rs | 149 | Clone in performance-critical code — consider references |
...
| HIGH | ? | client.rs | 88 | Clone in performance-critical code — consider references |
| HIGH | ? | client.rs | 145 | Clone in performance-critical code — consider references |
| HIGH | ? | client.rs | 147 | Clone in performance-critical code — consider references |
...
| HIGH | ? | config.rs | 56 | Clone in performance-critical code — consider references |
| HIGH | ? | db.rs | 43 | Clone in performance-critical code — consider references |
| HIGH | ? | db.rs | 207 | Clone in performance-critical code — consider references |
| HIGH | ? | db.rs | 479 | Clone in performance-critical code — consider references |
| HIGH | ? | db.rs | 499 | Clone in performance-critical code — consider references |
...
| HIGH | ? | test.rs | 276 | Clone in performance-critical code — consider references |
| HIGH | ? | test.rs | 412 | Clone in performance-critical code — consider references |
| HIGH | ? | test.rs | 418 | Clone in performance-critical code — consider references |
| HIGH | ? | test.rs | 426 | Clone in performance-critical code — consider references |
| HIGH | ? | test.rs | 440 | Clone in performance-critical code — consider references |
| HIGH | ? | test.rs | 477 | Clone in performance-critical code — consider references |
...
| HIGH | ? | mod.rs | 3428 | Clone in performance-critical code — consider references |
| HIGH | ? | mod.rs | 3497 | Clone in performance-critical code — consider references |
| HIGH | ? | mod.rs | 3747 | Clone in performance-critical code — consider references |
| HIGH | ? | mod.rs | 3759 | Clone in performance-critical code — consider references |
...
| HIGH | ? | lambda_assignment.rs | 162 | Clone in performance-critical code — consider references |
| HIGH | ? | lambda_assignment.rs | 171 | Clone in performance-critical code — consider references |
| HIGH | ? | lambda_assignment.rs | 206 | Clone in performance-critical code — consider references |
| HIGH | ? | lambda_assignment.rs | 207 | Clone in performance-critical code — consider references |
| HIGH | ? | lambda_assignment.rs | 209 | Clone in performance-critical code — consider references |
| HIGH | ? | lambda_assignment.rs | 220 | Clone in performance-critical code — consider references |
| HIGH | ? | lambda_assignment.rs | 221 | Clone in performance-critical code — consider references |
| HIGH | ? | lambda_assignment.rs | 223 | Clone in performance-critical code — consider references |
...
| HIGH | ? | ast_expr.rs | 226 | Clone in performance-critical code — consider references |
| HIGH | ? | ast_expr.rs | 307 | Clone in performance-critical code — consider references |
...
| HIGH | ? | mod.rs | 488 | Clone in performance-critical code — consider references |
...
| HIGH | ? | rule_selector.rs | 72 | Clone in performance-critical code — consider references |
| HIGH | ? | rule_selector.rs | 270 | Clone in performance-critical code — consider references |
...
| HIGH | ? | parser.rs | 780 | Clone in performance-critical code — consider references |
| HIGH | ? | parser.rs | 781 | Clone in performance-critical code — consider references |
| HIGH | ? | parser.rs | 869 | Clone in performance-critical code — consider references |
| HIGH | ? | parser.rs | 878 | Clone in performance-critical code — consider references |
| HIGH | ? | matcher.rs | 34 | Clone in performance-critical code — consider references |
| HIGH | ? | matcher.rs | 424 | Clone in performance-critical code — consider references |
| HIGH | ? | matcher.rs | 431 | Clone in performance-critical code — consider references |
| HIGH | ? | matcher.rs | 445 | Clone in performance-critical code — consider references |
| HIGH | ? | matcher.rs | 514 | Clone in performance-critical code — consider references |
| HIGH | ? | lib.rs | 723 | Clone in performance-critical code — consider references |
| HIGH | ? | options.rs | 1248 | Clone in performance-critical code — consider references |
| HIGH | ? | options.rs | 1255 | Clone in performance-critical code — consider references |
| HIGH | ? | options.rs | 1499 | Clone in performance-critical code — consider references |
| HIGH | ? | options.rs | 3054 | Clone in performance-critical code — consider references |
...
| HIGH | ? | resolve.rs | 225 | Clone in performance-critical code — consider references |
| HIGH | ? | resolve.rs | 265 | Clone in performance-critical code — consider references |
| HIGH | ? | resolve.rs | 390 | Clone in performance-critical code — consider references |
| HIGH | ? | resolve.rs | 677 | Clone in performance-critical code — consider references |
| HIGH | ? | resolve.rs | 692 | Clone in performance-critical code — consider references |
| HIGH | ? | resolve.rs | 918 | Clone in performance-critical code — consider references |
| HIGH | ? | resolve.rs | 975 | Clone in performance-critical code — consider references |
| HIGH | ? | resolve.rs | 976 | Clone in performance-critical code — consider references |
| HIGH | ? | resolve.rs | 1286 | Clone in performance-critical code — consider references |
| HIGH | ? | resolve.rs | 2603 | Clone in performance-critical code — consider references |
| HIGH | ? | resolve.rs | 2646 | Clone in performance-critical code — consider references |
| HIGH | ? | resolve.rs | 2668 | Clone in performance-critical code — consider references |
| HIGH | ? | resolve.rs | 2769 | Clone in performance-critical code — consider references |
| HIGH | ? | resolve.rs | 3301 | Clone in performance-critical code — consider references |
| HIGH | ? | list.rs | 15 | Clone in performance-critical code — consider references |
| HIGH | ? | list.rs | 31 | Clone in performance-critical code — consider references |
| HIGH | ? | list.rs | 182 | Clone in performance-critical code — consider references |
| HIGH | ? | list.rs | 254 | Clone in performance-critical code — consider references |
| HIGH | ? | list.rs | 982 | Clone in performance-critical code — consider references |
...
| HIGH | ? | module.rs | 196 | Clone in performance-critical code — consider references |
| HIGH | ? | module.rs | 209 | Clone in performance-critical code — consider references |
| HIGH | ? | module.rs | 230 | Clone in performance-critical code — consider references |
| HIGH | ? | module.rs | 246 | Clone in performance-critical code — consider references |
...
| HIGH | ? | lib.rs | 89 | Clone in performance-critical code — consider references |
| HIGH | ? | lib.rs | 111 | Clone in performance-critical code — consider references |
...
| HIGH | ? | indentation.rs | 129 | Clone in performance-critical code — consider references |
...
| HIGH | ? | ty_check_invalid_syntax.rs | 131 | Clone in performance-critical code — consider references |
...
| L | GS003 | collect_ty_ecosystem_run_metadata.py | 353 |
| L | GS003 | collect_ty_ecosystem_run_metadata.py | 357 |
...
| L | GS003 | memory_report.py | 262 |
| L | GS003 | memory_report.py | 282 |
| L | GS003 | memory_report.py | 342 |
| L | GS003 | memory_report.py | 357 |
| L | GS003 | memory_report.py | 367 |
| L | GS003 | memory_report.py | 368 |
| L | GS003 | memory_report.py | 370 |
| L | GS003 | memory_report.py | 380 |
| L | GS003 | memory_report.py | 382 |
| L | GS003 | memory_report.py | 383 |
| L | GS003 | memory_report.py | 412 |
| L | GS003 | memory_report.py | 413 |
| L | GS003 | memory_report.py | 415 |
...
| L | GS003 | linter.rs | 682 |
| L | GS003 | linter.rs | 692 |
| L | GS003 | linter.rs | 720 |
| L | GS003 | linter.rs | 730 |
...
| L | GS003 | main.rs | 106 |
| L | GS003 | main.rs | 115 |
| L | GS003 | docstring.rs | 1021 |
| L | GS003 | docstring.rs | 1033 |
| L | GS003 | docstring.rs | 1067 |
| L | GS003 | docstring.rs | 1079 |
...
| M | ? | projects.py | 266 |
| M | ? | projects.py | 286 |
| M | ? | collect_ty_ecosystem_run_metadata.py | 287 |
| M | ? | projects.py | 100 |
| C | ? | FAST002_1.py | 20 |
| C | ? | FAST002_2.py | 54 |
| H | ? | function.py | 17 |
...
| M | ? | ASYNC22x.py | 8 |
| M | ? | ASYNC22x.py | 38 |
| M | ? | memory_report.py | 264 |
| M | ? | memory_report.py | 284 |
...
| H | ? | google.rs | 200 |
| H | ? | completion.rs | 481 |
| H | ? | completion.rs | 2059 |
| H | ? | completion.rs | 11003 |
| H | ? | docstring.rs | 79 |
| H | ? | references.rs | 413 |
| H | ? | references.rs | 561 |
...
| H | ? | inlay_hints.rs | 65 |
| H | ? | inlay_hints.rs | 738 |
| H | ? | inlay_hints.rs | 880 |
| H | ? | inlay_hints.rs | 8516 |
| H | ? | inlay_hints.rs | 8518 |
| H | ? | goto.rs | 442 |
| H | ? | lib.rs | 461 |
| H | ? | lib.rs | 641 |
| H | ? | lib.rs | 662 |
...
| H | ? | fixes.rs | 1512 |
| H | ? | pydantic.rs | 256 |
| H | ? | diagnostic.rs | 1605 |
| H | ? | diagnostic.rs | 1817 |
| H | ? | diagnostic.rs | 1818 |
| H | ? | diagnostic.rs | 1886 |
| H | ? | diagnostic.rs | 2068 |
| H | ? | diagnostic.rs | 2198 |
| H | ? | diagnostic.rs | 3820 |
| H | ? | diagnostic.rs | 3828 |
| H | ? | diagnostic.rs | 4161 |
| H | ? | diagnostic.rs | 4168 |
| H | ? | diagnostic.rs | 4174 |
| H | ? | diagnostic.rs | 4180 |
| H | ? | diagnostic.rs | 4181 |
| H | ? | diagnostic.rs | 4217 |
| H | ? | diagnostic.rs | 4234 |
| H | ? | diagnostic.rs | 4318 |
| H | ? | diagnostic.rs | 4324 |
| H | ? | diagnostic.rs | 4330 |
| H | ? | diagnostic.rs | 4335 |
| H | ? | diagnostic.rs | 4336 |
| H | ? | arguments.rs | 263 |
| H | ? | arguments.rs | 386 |
| H | ? | bind.rs | 244 |
| H | ? | bind.rs | 3114 |
...
| H | ? | signatures.rs | 828 |
| H | ? | signatures.rs | 955 |
| H | ? | signatures.rs | 1063 |
| H | ? | signatures.rs | 1115 |
| H | ? | signatures.rs | 1133 |
| H | ? | signatures.rs | 1134 |
| H | ? | signatures.rs | 1265 |
| H | ? | signatures.rs | 1266 |
| H | ? | signatures.rs | 1340 |
| H | ? | signatures.rs | 1578 |
| H | ? | signatures.rs | 1630 |
| H | ? | signatures.rs | 1858 |
| H | ? | signatures.rs | 1902 |
| H | ? | signatures.rs | 2121 |
| H | ? | signatures.rs | 2122 |
| H | ? | signatures.rs | 2157 |
| H | ? | signatures.rs | 2182 |
| H | ? | signatures.rs | 2221 |
| H | ? | signatures.rs | 2385 |
| H | ? | signatures.rs | 2846 |
| H | ? | signatures.rs | 2847 |
| H | ? | signatures.rs | 2942 |
| H | ? | signatures.rs | 2943 |
| H | ? | signatures.rs | 2957 |
| H | ? | signatures.rs | 3242 |
| H | ? | signatures.rs | 3253 |
| H | ? | signatures.rs | 3372 |
| H | ? | signatures.rs | 3393 |
| H | ? | signatures.rs | 3680 |
| H | ? | signatures.rs | 3712 |
| H | ? | signatures.rs | 3724 |
| H | ? | signatures.rs | 3735 |
| H | ? | signatures.rs | 3747 |
| H | ? | signatures.rs | 3890 |
| H | ? | signatures.rs | 3893 |
| H | ? | signatures.rs | 3897 |
| H | ? | signatures.rs | 3900 |
| H | ? | signatures.rs | 3904 |
| H | ? | signatures.rs | 3909 |
| H | ? | signatures.rs | 3913 |
| H | ? | signatures.rs | 3957 |
| H | ? | signatures.rs | 4187 |
| H | ? | signatures.rs | 4199 |
| H | ? | signatures.rs | 4213 |
| H | ? | signatures.rs | 4223 |
| H | ? | signatures.rs | 4225 |
| H | ? | signatures.rs | 4402 |
| H | ? | signatures.rs | 4405 |
| H | ? | signatures.rs | 4476 |
| H | ? | signatures.rs | 4486 |
| H | ? | signatures.rs | 4496 |
| H | ? | signatures.rs | 4502 |
| H | ? | signatures.rs | 4526 |
| H | ? | signatures.rs | 4530 |
| H | ? | signatures.rs | 4534 |
| H | ? | signatures.rs | 4536 |
| H | ? | class.rs | 1345 |
| H | ? | class.rs | 2169 |
| H | ? | relation_error.rs | 24 |
| H | ? | ide_support.rs | 602 |
| H | ? | ide_support.rs | 705 |
| H | ? | ide_support.rs | 809 |
| H | ? | ide_support.rs | 2086 |
| H | ? | known_instance.rs | 680 |
| H | ? | known_instance.rs | 714 |
| H | ? | class_base.rs | 479 |
| H | ? | overrides.rs | 483 |
| H | ? | overrides.rs | 747 |
| H | ? | overrides.rs | 1444 |
| H | ? | relation.rs | 848 |
| H | ? | match_pattern.rs | 849 |
| H | ? | match_pattern.rs | 860 |
| H | ? | callable.rs | 164 |
| H | ? | callable.rs | 185 |
| H | ? | callable.rs | 725 |
| H | ? | callable.rs | 726 |
...
| H | ? | static_class.rs | 820 |
| H | ? | static_class.rs | 831 |
| H | ? | static_class.rs | 838 |
| H | ? | static_class.rs | 1058 |
| H | ? | static_class.rs | 1075 |
| H | ? | function.rs | 206 |
| H | ? | function.rs | 226 |
| H | ? | function.rs | 237 |
...
| H | ? | imports.rs | 576 |
| H | ? | new_class.rs | 124 |
| H | ? | named_tuple.rs | 533 |
| H | ? | named_tuple.rs | 682 |
| H | ? | typevar.rs | 121 |
| H | ? | builder.rs | 523 |
| H | ? | builder.rs | 597 |
| H | ? | builder.rs | 627 |
...
| H | ? | display.rs | 2958 |
| H | ? | display.rs | 2973 |
| H | ? | constraints.rs | 284 |
| H | ? | constraints.rs | 3104 |
| H | ? | constraints.rs | 6667 |
| H | ? | constraints.rs | 6668 |
| H | ? | constraints.rs | 6682 |
| H | ? | constraints.rs | 6683 |
| H | ? | static_literal.rs | 1366 |
| H | ? | static_literal.rs | 1554 |
| H | ? | static_literal.rs | 1565 |
| H | ? | static_literal.rs | 1572 |
| H | ? | static_literal.rs | 1656 |
| H | ? | static_literal.rs | 2022 |
| H | ? | static_literal.rs | 2027 |
| H | ? | static_literal.rs | 2059 |
| H | ? | static_literal.rs | 2170 |
| H | ? | static_literal.rs | 2197 |
| H | ? | static_literal.rs | 2317 |
| H | ? | dynamic_literal.rs | 551 |
| H | ? | enum_literal.rs | 40 |
| H | ? | enum_literal.rs | 251 |
| H | ? | typed_dict.rs | 155 |
| H | ? | typed_dict.rs | 163 |
| H | ? | typed_dict.rs | 166 |
| H | ? | typed_dict.rs | 172 |
...
| H | ? | set_theoretic.rs | 792 |
| H | ? | set_theoretic.rs | 801 |
| H | ? | list_members.rs | 49 |
| H | ? | list_members.rs | 69 |
| H | ? | list_members.rs | 104 |
| H | ? | list_members.rs | 120 |
| H | ? | list_members.rs | 416 |
| H | ? | list_members.rs | 425 |
| H | ? | protocol_class.rs | 256 |
| H | ? | protocol_class.rs | 258 |
| H | ? | protocol_class.rs | 368 |
| H | ? | protocol_class.rs | 389 |
| H | ? | protocol_class.rs | 2104 |
| H | ? | subscript.rs | 237 |
| H | ? | subscript.rs | 238 |
| H | ? | subscript.rs | 239 |
| H | ? | subscript.rs | 240 |
...
| H | ? | reachability.rs | 566 |
| H | ? | reachability.rs | 926 |
| H | ? | reachability.rs | 933 |
| H | ? | reachability.rs | 1084 |
| H | ? | reachability.rs | 1097 |
| H | ? | reachability.rs | 1100 |
| H | ? | lib.rs | 190 |
| H | ? | document.rs | 302 |
| H | ? | document.rs | 387 |
| H | ? | buffer.rs | 382 |
...
| H | ? | lambda_assignment.rs | 162 |
| H | ? | lambda_assignment.rs | 171 |
| H | ? | lambda_assignment.rs | 206 |
| H | ? | lambda_assignment.rs | 207 |
| H | ? | lambda_assignment.rs | 209 |
| H | ? | lambda_assignment.rs | 220 |
| H | ? | lambda_assignment.rs | 221 |
| H | ? | lambda_assignment.rs | 223 |
...
| H | ? | rule_selector.rs | 72 |
| H | ? | rule_selector.rs | 270 |
| H | ? | source_kind.rs | 92 |
| H | ? | types.rs | 277 |
| H | ? | mod.rs | 821 |
| H | ? | rule_table.rs | 84 |
...
| H | ? | ty_check_invalid_syntax.rs | 131 |
| H | ? | ruff_formatter_validity.rs | 55 |
| H | ? | ruff_formatter_validity.rs | 64 |

---
*Сгенерировано GSC v0.6 · 2026-07-13T04:03:54.558595*