...
**Дата:** 16.07.2026 04:00  
**Путь:** `/tmp/gsc-learn/scrapy`  
**Всего находок:** 261  
**CRITICAL:** 4 | **HIGH:** 17 | **MEDIUM:** 187 | **LOW:** 52

## 📊 По детекторам

| Детектор | Находок |
|----------|--------|
| Python: assert in production | 180 |
| GS003 | 45 |
| GS008 | 6 |
| Хардкод IP адреса | 6 |
...
|-----------|--------|------|--------|--------|
| CRITICAL | GS001 | default_settings.py | 399 | Found: PASSWORD = "guest" |
...
| HIGH | ? | feedexport.py | 282 | File upload without MIME-type validation → malicious file up |
| HIGH | ? | feedexport.py | 289 | File upload without MIME-type validation → malicious file up |
| HIGH | ? | feedexport.py | 344 | File upload without MIME-type validation → malicious file up |
| HIGH | ? | images.py | 241 | File upload without MIME-type validation → malicious file up |
| HIGH | ? | lxmlhtml.py | 272 |  |
| HIGH | ? | form.py | 236 |  |
| HIGH | ? | default_settings.py | 570 | Match: TELNETCONSOLE_HOST = "127.0.0.1" |
| HIGH | ? | tox.ini | 89 | Match:     types-Pygments==2.20.0.20260518 |
| HIGH | ? | tox.ini | 90 | Match:     types-defusedxml==0.7.0.20260504 |
| HIGH | ? | tox.ini | 92 | Match:     types-pexpect==4.9.0.20260518 |
| HIGH | ? | tox.ini | 175 | Match:     brotlicffi >= 1.2.0.0; implementation_name == "py |
...
| H | ? | form.py | 236 |
| M | ? | scheduler.py | 454 |
| C | GS001 | default_settings.py | 399 |
...
| L | GS003 | trackref.py | 64 |
| L | GS008 | default_settings.py | 276 |
...
---
*Сгенерировано GSC v0.6 · 2026-07-16T04:00:51.573047*