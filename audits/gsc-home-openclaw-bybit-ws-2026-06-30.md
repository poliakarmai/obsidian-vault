...
**Дата:** 30.06.2026 08:27  
**Путь:** `/home/openclaw/bybit-ws`  
**Всего находок:** 585  
**CRITICAL:** 3 | **HIGH:** 29 | **MEDIUM:** 19 | **LOW:** 531
...
| HIGH | ? | main_async.py | 581 | Match:         ws_push_thread = start_ws_server(port=8768, b |
| HIGH | ? | main_async.py | 582 | Match:         log_event('📡 WebSocket push server on 127.0.0 |
...
| HIGH | ? | rpc.py | 1642 | Match: def start_rpc_server(port=8766, bind='127.0.0.1'): |
...
| L | GS003 | main_async.py | 482 |
| L | GS003 | main_async.py | 538 |
...
---
*Сгенерировано GSC v0.6 · 2026-06-30T08:27:51.879200*