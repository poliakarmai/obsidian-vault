...
**Дата:** 15.07.2026 04:01  
**Путь:** `/tmp/gsc-learn/pipenv`  
**Всего находок:** 776  
**CRITICAL:** 4 | **HIGH:** 24 | **MEDIUM:** 300 | **LOW:** 444
...
| GS003 | 127 |
| Outdated dependency pattern | 54 |
...
| HIGH | ? | virtualenv.py | 687 | Match:         exec(code, {"__file__": str(activate_path)}) |
...
| HIGH | GS004 | virtualenv.py | 687 | Line 687: exec(code, {"__file__": str(activate_path)}) |
...
| M | ? | misc.py | 469 |
| M | ? | misc.py | 472 |
| M | ? | requirements.py | 39 |
| M | ? | requirements.py | 44 |
| M | ? | requirements.py | 47 |
...
| L | GS003 | command.py | 262 |
| L | GS003 | command.py | 637 |
| L | GS003 | command.py | 752 |
...
| L | GS008 | environments.py | 494 |
| L | GS008 | environments.py | 495 |
...
| M | ? | shell.py | 193 |
| M | ? | shell.py | 197 |
| M | ? | requirementslib.py | 196 |
| M | ? | requirementslib.py | 206 |
| M | ? | requirementslib.py | 221 |
| M | ? | pipfile.py | 93 |
| M | ? | pipfile.py | 113 |
| M | ? | dependencies.py | 984 |
| M | ? | resolver.py | 1514 |
| M | ? | resolver.py | 1515 |
| M | ? | constants.py | 36 |
| M | ? | command.py | 523 |
...
---
*Сгенерировано GSC v0.6 · 2026-07-15T04:01:41.243920*