...
**Дата:** 03.08.2026 04:09  
**Путь:** `/tmp/gsc-learn/cryptography`  
**Всего находок:** 2292  
**CRITICAL:** 3 | **HIGH:** 1804 | **MEDIUM:** 328 | **LOW:** 132
...
|----------|--------|
| GS002 | 1146 |
| Хардкод IP адреса | 442 |
| GS014 | 305 |
| Rust: .clone() in hot path | 213 |
| GS008 | 94 |
| GS003 | 38 |
| GS007 | 24 |
...
|-----------|--------|------|--------|--------|
| CRITICAL | GS001 | _oid.py | 372 | Found: PASSWORD: "challengePassword" |
...
| HIGH | ? | _oid.py | 90 | Match:     UNSIGNED = ObjectIdentifier("1.3.6.1.5.5.7.25.1") |
| HIGH | ? | _oid.py | 94 | Match:     RSA_WITH_MD5 = ObjectIdentifier("1.2.840.113549.1 |
| HIGH | ? | _oid.py | 95 | Match:     RSA_WITH_SHA1 = ObjectIdentifier("1.2.840.113549. |
| HIGH | ? | _oid.py | 97 | Match:     _RSA_WITH_SHA1 = ObjectIdentifier("1.3.14.3.2.29" |
| HIGH | ? | _oid.py | 98 | Match:     RSA_WITH_SHA224 = ObjectIdentifier("1.2.840.11354 |
| HIGH | ? | _oid.py | 99 | Match:     RSA_WITH_SHA256 = ObjectIdentifier("1.2.840.11354 |
| HIGH | ? | _oid.py | 100 | Match:     RSA_WITH_SHA384 = ObjectIdentifier("1.2.840.11354 |
| HIGH | ? | _oid.py | 101 | Match:     RSA_WITH_SHA512 = ObjectIdentifier("1.2.840.11354 |
| HIGH | ? | _oid.py | 102 | Match:     RSA_WITH_SHA3_224 = ObjectIdentifier("2.16.840.1. |
| HIGH | ? | _oid.py | 103 | Match:     RSA_WITH_SHA3_256 = ObjectIdentifier("2.16.840.1. |
| HIGH | ? | _oid.py | 104 | Match:     RSA_WITH_SHA3_384 = ObjectIdentifier("2.16.840.1. |
| HIGH | ? | _oid.py | 105 | Match:     RSA_WITH_SHA3_512 = ObjectIdentifier("2.16.840.1. |
| HIGH | ? | _oid.py | 106 | Match:     RSASSA_PSS = ObjectIdentifier("1.2.840.113549.1.1 |
| HIGH | ? | _oid.py | 108 | Match:     ECDSA_WITH_SHA224 = ObjectIdentifier("1.2.840.100 |
| HIGH | ? | _oid.py | 109 | Match:     ECDSA_WITH_SHA256 = ObjectIdentifier("1.2.840.100 |
| HIGH | ? | _oid.py | 110 | Match:     ECDSA_WITH_SHA384 = ObjectIdentifier("1.2.840.100 |
| HIGH | ? | _oid.py | 111 | Match:     ECDSA_WITH_SHA512 = ObjectIdentifier("1.2.840.100 |
| HIGH | ? | _oid.py | 112 | Match:     ECDSA_WITH_SHA3_224 = ObjectIdentifier("2.16.840. |
| HIGH | ? | _oid.py | 113 | Match:     ECDSA_WITH_SHA3_256 = ObjectIdentifier("2.16.840. |
| HIGH | ? | _oid.py | 114 | Match:     ECDSA_WITH_SHA3_384 = ObjectIdentifier("2.16.840. |
| HIGH | ? | _oid.py | 115 | Match:     ECDSA_WITH_SHA3_512 = ObjectIdentifier("2.16.840. |
| HIGH | ? | _oid.py | 117 | Match:     DSA_WITH_SHA224 = ObjectIdentifier("2.16.840.1.10 |
| HIGH | ? | _oid.py | 118 | Match:     DSA_WITH_SHA256 = ObjectIdentifier("2.16.840.1.10 |
| HIGH | ? | _oid.py | 119 | Match:     DSA_WITH_SHA384 = ObjectIdentifier("2.16.840.1.10 |
| HIGH | ? | _oid.py | 120 | Match:     DSA_WITH_SHA512 = ObjectIdentifier("2.16.840.1.10 |
| HIGH | ? | _oid.py | 121 | Match:     ED25519 = ObjectIdentifier("1.3.101.112") |
| HIGH | ? | _oid.py | 122 | Match:     ED448 = ObjectIdentifier("1.3.101.113") |
| HIGH | ? | _oid.py | 123 | Match:     ML_DSA_44 = ObjectIdentifier("2.16.840.1.101.3.4. |
| HIGH | ? | _oid.py | 124 | Match:     ML_DSA_65 = ObjectIdentifier("2.16.840.1.101.3.4. |
| HIGH | ? | _oid.py | 125 | Match:     ML_DSA_87 = ObjectIdentifier("2.16.840.1.101.3.4. |
| HIGH | ? | _oid.py | 126 | Match:     GOSTR3411_94_WITH_3410_2001 = ObjectIdentifier("1 |
| HIGH | ? | _oid.py | 127 | Match:     GOSTR3410_2012_WITH_3411_2012_256 = ObjectIdentif |
| HIGH | ? | _oid.py | 128 | Match:     GOSTR3410_2012_WITH_3411_2012_512 = ObjectIdentif |
| HIGH | ? | _oid.py | 129 | Match:     UNSIGNED = ObjectIdentifier("1.3.6.1.5.5.7.6.36") |
| HIGH | ? | _oid.py | 169 | Match:     SHA1 = ObjectIdentifier("1.3.14.3.2.26") |
| HIGH | ? | _oid.py | 170 | Match:     SHA224 = ObjectIdentifier("2.16.840.1.101.3.4.2.4 |
| HIGH | ? | _oid.py | 171 | Match:     SHA256 = ObjectIdentifier("2.16.840.1.101.3.4.2.1 |
| HIGH | ? | _oid.py | 172 | Match:     SHA384 = ObjectIdentifier("2.16.840.1.101.3.4.2.2 |
| HIGH | ? | _oid.py | 173 | Match:     SHA512 = ObjectIdentifier("2.16.840.1.101.3.4.2.3 |
| HIGH | ? | _oid.py | 174 | Match:     SHA3_224 = ObjectIdentifier("1.3.6.1.4.1.37476.3. |
| HIGH | ? | _oid.py | 175 | Match:     SHA3_256 = ObjectIdentifier("1.3.6.1.4.1.37476.3. |
| HIGH | ? | _oid.py | 176 | Match:     SHA3_384 = ObjectIdentifier("1.3.6.1.4.1.37476.3. |
| HIGH | ? | _oid.py | 177 | Match:     SHA3_512 = ObjectIdentifier("1.3.6.1.4.1.37476.3. |
| HIGH | ? | _oid.py | 178 | Match:     SHA3_224_NIST = ObjectIdentifier("2.16.840.1.101. |
| HIGH | ? | _oid.py | 179 | Match:     SHA3_256_NIST = ObjectIdentifier("2.16.840.1.101. |
| HIGH | ? | _oid.py | 180 | Match:     SHA3_384_NIST = ObjectIdentifier("2.16.840.1.101. |
| HIGH | ? | _oid.py | 181 | Match:     SHA3_512_NIST = ObjectIdentifier("2.16.840.1.101. |
| HIGH | ? | _oid.py | 187 | Match:     RSAES_PKCS1_v1_5 = ObjectIdentifier("1.2.840.1135 |
| HIGH | ? | _oid.py | 188 | Match:     RSASSA_PSS = ObjectIdentifier("1.2.840.113549.1.1 |
| HIGH | ? | _oid.py | 189 | Match:     X25519 = ObjectIdentifier("1.3.101.110") |
| HIGH | ? | _oid.py | 190 | Match:     X448 = ObjectIdentifier("1.3.101.111") |
| HIGH | ? | _oid.py | 191 | Match:     ED25519 = ObjectIdentifier("1.3.101.112") |
| HIGH | ? | _oid.py | 192 | Match:     ED448 = ObjectIdentifier("1.3.101.113") |
| HIGH | ? | _oid.py | 193 | Match:     ML_DSA_44 = ObjectIdentifier("2.16.840.1.101.3.4. |
| HIGH | ? | _oid.py | 194 | Match:     ML_DSA_65 = ObjectIdentifier("2.16.840.1.101.3.4. |
| HIGH | ? | _oid.py | 195 | Match:     ML_DSA_87 = ObjectIdentifier("2.16.840.1.101.3.4. |
| HIGH | ? | _oid.py | 196 | Match:     ML_KEM_768 = ObjectIdentifier("2.16.840.1.101.3.4 |
| HIGH | ? | _oid.py | 197 | Match:     ML_KEM_1024 = ObjectIdentifier("2.16.840.1.101.3. |
| HIGH | ? | _oid.py | 201 | Match:     SERVER_AUTH = ObjectIdentifier("1.3.6.1.5.5.7.3.1 |
| HIGH | ? | _oid.py | 202 | Match:     CLIENT_AUTH = ObjectIdentifier("1.3.6.1.5.5.7.3.2 |
| HIGH | ? | _oid.py | 203 | Match:     CODE_SIGNING = ObjectIdentifier("1.3.6.1.5.5.7.3. |
| HIGH | ? | _oid.py | 204 | Match:     EMAIL_PROTECTION = ObjectIdentifier("1.3.6.1.5.5. |
| HIGH | ? | _oid.py | 205 | Match:     TIME_STAMPING = ObjectIdentifier("1.3.6.1.5.5.7.3 |
| HIGH | ? | _oid.py | 206 | Match:     OCSP_SIGNING = ObjectIdentifier("1.3.6.1.5.5.7.3. |
| HIGH | ? | _oid.py | 207 | Match:     ANY_EXTENDED_KEY_USAGE = ObjectIdentifier("2.5.29 |
| HIGH | ? | _oid.py | 208 | Match:     SMARTCARD_LOGON = ObjectIdentifier("1.3.6.1.4.1.3 |
| HIGH | ? | _oid.py | 209 | Match:     KERBEROS_PKINIT_KDC = ObjectIdentifier("1.3.6.1.5 |
| HIGH | ? | _oid.py | 210 | Match:     IPSEC_IKE = ObjectIdentifier("1.3.6.1.5.5.7.3.17" |
| HIGH | ? | _oid.py | 211 | Match:     BUNDLE_SECURITY = ObjectIdentifier("1.3.6.1.5.5.7 |
| HIGH | ? | _oid.py | 212 | Match:     CERTIFICATE_TRANSPARENCY = ObjectIdentifier("1.3. |
| HIGH | ? | _oid.py | 216 | Match:     PERMANENT_IDENTIFIER = ObjectIdentifier("1.3.6.1. |
| HIGH | ? | _oid.py | 217 | Match:     HW_MODULE_NAME = ObjectIdentifier("1.3.6.1.5.5.7. |
| HIGH | ? | _oid.py | 218 | Match:     DNS_SRV = ObjectIdentifier("1.3.6.1.5.5.7.8.7") |
| HIGH | ? | _oid.py | 219 | Match:     NAI_REALM = ObjectIdentifier("1.3.6.1.5.5.7.8.8") |
| HIGH | ? | _oid.py | 220 | Match:     SMTP_UTF8_MAILBOX = ObjectIdentifier("1.3.6.1.5.5 |
| HIGH | ? | _oid.py | 221 | Match:     ACP_NODE_NAME = ObjectIdentifier("1.3.6.1.5.5.7.8 |
| HIGH | ? | _oid.py | 222 | Match:     BUNDLE_EID = ObjectIdentifier("1.3.6.1.5.5.7.8.11 |
| HIGH | ? | _oid.py | 226 | Match:     CA_ISSUERS = ObjectIdentifier("1.3.6.1.5.5.7.48.2 |
| HIGH | ? | _oid.py | 227 | Match:     OCSP = ObjectIdentifier("1.3.6.1.5.5.7.48.1") |
| HIGH | ? | _oid.py | 231 | Match:     CA_REPOSITORY = ObjectIdentifier("1.3.6.1.5.5.7.4 |
| HIGH | ? | _oid.py | 235 | Match:     CPS_QUALIFIER = ObjectIdentifier("1.3.6.1.5.5.7.2 |
| HIGH | ? | _oid.py | 236 | Match:     CPS_USER_NOTICE = ObjectIdentifier("1.3.6.1.5.5.7 |
| HIGH | ? | _oid.py | 237 | Match:     ANY_POLICY = ObjectIdentifier("2.5.29.32.0") |
| HIGH | ? | _oid.py | 241 | Match:     CHALLENGE_PASSWORD = ObjectIdentifier("1.2.840.11 |
| HIGH | ? | _oid.py | 242 | Match:     UNSTRUCTURED_NAME = ObjectIdentifier("1.2.840.113 |
...
| HIGH | ? | mod.rs | 809 | Match:         let ip_sub = Subject::IP(IPAddress::from_str( |
| HIGH | ? | lib.rs | 625 | Match:             "invalid extension: 2.5.29.17: duplicate  |
...
| HIGH | ? | mod.rs | 91 | Clone in performance-critical code — consider references |
...
| HIGH | ? | mod.rs | 177 | Clone in performance-critical code — consider references |
...
| HIGH | ? | mod.rs | 181 | Clone in performance-critical code — consider references |
...
| HIGH | ? | mod.rs | 861 | Clone in performance-critical code — consider references |
| HIGH | ? | mod.rs | 871 | Clone in performance-critical code — consider references |
| HIGH | ? | mod.rs | 881 | Clone in performance-critical code — consider references |
| HIGH | ? | mod.rs | 890 | Clone in performance-critical code — consider references |
| HIGH | ? | mod.rs | 900 | Clone in performance-critical code — consider references |
...
| HIGH | ? | lib.rs | 467 | Clone in performance-critical code — consider references |
| HIGH | ? | lib.rs | 532 | Clone in performance-critical code — consider references |
| HIGH | ? | lib.rs | 584 | Clone in performance-critical code — consider references |
...
| HIGH | ? | pkcs7.rs | 404 | Clone in performance-critical code — consider references |
| HIGH | ? | pkcs7.rs | 520 | Clone in performance-critical code — consider references |
| HIGH | ? | pkcs7.rs | 532 | Clone in performance-critical code — consider references |
| HIGH | ? | pkcs7.rs | 533 | Clone in performance-critical code — consider references |
| HIGH | ? | pkcs7.rs | 534 | Clone in performance-critical code — consider references |
| HIGH | ? | pkcs7.rs | 582 | Clone in performance-critical code — consider references |
| HIGH | ? | pkcs7.rs | 583 | Clone in performance-critical code — consider references |
| HIGH | ? | pkcs7.rs | 584 | Clone in performance-critical code — consider references |
| HIGH | ? | pkcs7.rs | 594 | Clone in performance-critical code — consider references |
| HIGH | ? | pkcs7.rs | 597 | Clone in performance-critical code — consider references |
| HIGH | ? | pkcs7.rs | 599 | Clone in performance-critical code — consider references |
| HIGH | ? | pkcs7.rs | 604 | Clone in performance-critical code — consider references |
| HIGH | ? | pkcs7.rs | 611 | Clone in performance-critical code — consider references |
| HIGH | ? | pkcs7.rs | 612 | Clone in performance-critical code — consider references |
| HIGH | ? | pkcs7.rs | 613 | Clone in performance-critical code — consider references |
| HIGH | ? | pkcs7.rs | 678 | Clone in performance-critical code — consider references |
| HIGH | ? | pkcs7.rs | 819 | Clone in performance-critical code — consider references |
...
| HIGH | ? | encode.rs | 389 | Clone in performance-critical code — consider references |
...
| HIGH | ? | mldsa.rs | 865 | Clone in performance-critical code — consider references |
| HIGH | ? | hpke.rs | 843 | Clone in performance-critical code — consider references |
| HIGH | ? | hpke.rs | 867 | Clone in performance-critical code — consider references |
| HIGH | ? | hmac.rs | 38 | Clone in performance-critical code — consider references |
| HIGH | ? | hashes.rs | 101 | Clone in performance-critical code — consider references |
| HIGH | ? | hashes.rs | 140 | Clone in performance-critical code — consider references |
| HIGH | ? | hashes.rs | 232 | Clone in performance-critical code — consider references |
| HIGH | ? | hashes.rs | 275 | Clone in performance-critical code — consider references |
| HIGH | ? | ciphers.rs | 29 | Clone in performance-critical code — consider references |
| HIGH | ? | ciphers.rs | 619 | Clone in performance-critical code — consider references |
| HIGH | ? | ciphers.rs | 652 | Clone in performance-critical code — consider references |
...
| HIGH | ? | ocsp_resp.rs | 119 | Clone in performance-critical code — consider references |
| HIGH | ? | ocsp_resp.rs | 273 | Clone in performance-critical code — consider references |
| HIGH | ? | ocsp_resp.rs | 563 | Clone in performance-critical code — consider references |
| HIGH | ? | ocsp_resp.rs | 819 | Clone in performance-critical code — consider references |
| HIGH | ? | ocsp_resp.rs | 841 | Clone in performance-critical code — consider references |
| HIGH | ? | ocsp_resp.rs | 842 | Clone in performance-critical code — consider references |
| HIGH | ? | ocsp_resp.rs | 848 | Clone in performance-critical code — consider references |
| HIGH | ? | ocsp_resp.rs | 849 | Clone in performance-critical code — consider references |
| HIGH | ? | ocsp_resp.rs | 871 | Clone in performance-critical code — consider references |
...
| HIGH | ? | ocsp_req.rs | 73 | Clone in performance-critical code — consider references |
...
| HIGH | ? | certificate.rs | 1020 | Clone in performance-critical code — consider references |
| HIGH | ? | certificate.rs | 1021 | Clone in performance-critical code — consider references |
| HIGH | ? | certificate.rs | 1022 | Clone in performance-critical code — consider references |
| HIGH | ? | certificate.rs | 1081 | Clone in performance-critical code — consider references |
| HIGH | ? | certificate.rs | 1106 | Clone in performance-critical code — consider references |
| HIGH | ? | certificate.rs | 1107 | Clone in performance-critical code — consider references |
| HIGH | ? | certificate.rs | 1108 | Clone in performance-critical code — consider references |
...
| HIGH | ? | cobblestone.rs | 161 | Clone in performance-critical code — consider references |
...
| L | GS003 | build.rs | 65 |
| L | GS003 | build.rs | 66 |
| L | GS003 | build.rs | 158 |
| L | GS003 | build.rs | 195 |
| L | GS003 | build.rs | 209 |
| L | GS003 | build.rs | 14 |
| L | GS003 | build.rs | 17 |
| L | GS003 | build.rs | 21 |
| L | GS003 | build.rs | 25 |
...
| H | ? | certificate.rs | 1020 |
| H | ? | certificate.rs | 1021 |
| H | ? | certificate.rs | 1022 |
| H | ? | certificate.rs | 1081 |
| H | ? | certificate.rs | 1106 |
| H | ? | certificate.rs | 1107 |
| H | ? | certificate.rs | 1108 |
| H | ? | mod.rs | 46 |
| H | ? | mod.rs | 95 |
| H | ? | mod.rs | 186 |
| H | ? | mod.rs | 233 |
...
---
*Сгенерировано GSC v0.6 · 2026-08-03T04:09:27.612684*