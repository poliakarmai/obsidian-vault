...
| HIGH | GS004 | _asyncio.py | 2751 | Line 2751: transport, protocol = await loop.subprocess_exec( |
...
| H | ? | .readthedocs.yml | 0 |
| H | GS004 | _asyncio.py | 2751 |
| H | GS004 | to_interpreter.py | 123 |
| s | GS009 |  | 0 |

---
*Сгенерировано GSC v0.6 · 2026-07-21T04:00:51.869756*