...
**Дата:** 28.06.2026 18:42  
**Путь:** `/home/openclaw/bybit-ws`  
**Всего находок:** 484  
**CRITICAL:** 3 | **HIGH:** 32 | **MEDIUM:** 21 | **LOW:** 428
...
| HIGH | ? | main_async.py | 250 | Match:         ws_push_thread = start_ws_server(port=8767, b |
| HIGH | ? | main_async.py | 251 | Match:         log_event('📡 WebSocket push server on 127.0.0 |
| HIGH | ? | main_async.py | 372 | Match:         ws_push_thread = start_ws_server(port=8767, b |
| HIGH | ? | main_async.py | 373 | Match:         log_event('📡 WebSocket push server on 127.0.0 |
...
| HIGH | ? | rpc.py | 1614 | Match: def start_rpc_server(port=8766, bind='127.0.0.1'): |
...
| L | GS003 | main_async.py | 199 |
| L | GS003 | main_async.py | 209 |
...
| L | GS003 | main.py | 1132 |
| L | GS003 | main.py | 1134 |
| L | GS003 | main_async.py | 321 |
| L | GS003 | main_async.py | 331 |
| L | GS003 | margin_alerts.py | 202 |
| L | GS003 | margin_alerts.py | 204 |
| L | GS003 | margin_alerts.py | 208 |
| L | GS003 | margin_alerts.py | 213 |
...
---
*Сгенерировано GSC v0.6 · 2026-06-28T18:42:16.182849*