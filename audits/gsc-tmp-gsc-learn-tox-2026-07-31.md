...
**Всего находок:** 125  
**CRITICAL:** 0 | **HIGH:** 3 | **MEDIUM:** 43 | **LOW:** 73
...
|-----------|--------|------|--------|--------|
| HIGH | ? | pyproject.toml | 125 | Match:   "sphinx-inline-tabs>=2025.12.21.14", |
...
| L | GS003 | common.py | 158 |
| L | GS003 | common.py | 222 |
...
| I | GS007 | api.py | 28 |
| I | GS007 | api.py | 194 |
| I | GS007 | subprocess_adapter.py | 151 |
| s | GS009 |  | 0 |
| M | ? | man.py | 69 |
| M | ? | subprocess_adapter.py | 121 |
| M | ? | subprocess_adapter.py | 140 |
| M | ? | subprocess_adapter.py | 183 |
| M | ? | subprocess_adapter.py | 220 |

---
*Сгенерировано GSC v0.6 · 2026-07-31T04:01:39.445220*