...
**Всего находок:** 82  
**CRITICAL:** 2 | **HIGH:** 6 | **MEDIUM:** 5 | **LOW:** 68
...
|-----------|--------|------|--------|--------|
| CRITICAL | GS005 | rich.py | 61 | Line 61: return Text(f"? {self.unit}/s", style="progress.dat |
| CRITICAL | GS005 | rich.py | 71 | Line 71: return Text(f"{speed/unit:,.{precision}f} {suffix}{ |
...
| C | GS005 | rich.py | 71 |
| s | GS009 |  | 0 |
| L | GS012 | asyncio.py | 49 |
| L | GS012 | concurrent.py | 160 |
| L | GS012 | dask.py | 33 |
| L | GS012 | std.py | 1215 |
| L | GS012 | std.py | 1253 |
| L | GS012 | tk.py | 113 |
...
---
*Сгенерировано GSC v0.6 · 2026-07-30T04:10:19.007048*