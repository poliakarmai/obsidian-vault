...
**Всего находок:** 652  
**CRITICAL:** 6 | **HIGH:** 340 | **MEDIUM:** 82 | **LOW:** 221
...
| HIGH | GS014 | networks.py | 773 | Database URL contains password in plaintext. Use environment |
| HIGH | GS014 | networks.py | 775 | Database URL contains password in plaintext. Use environment |
| HIGH | GS014 | networks.py | 778 | Database URL contains password in plaintext. Use environment |
| HIGH | GS014 | networks.py | 786 | Database URL contains password in plaintext. Use environment |
| HIGH | GS014 | networks.py | 786 | Database URL contains password in plaintext. Use environment |
...
| M | ? | type_adapter.py | 736 |
| M | ? | type_adapter.py | 790 |
...
| H | ? | push.py | 71 |
| H | ? | push.py | 126 |
| M | ? | _known_annotated_metadata.py | 265 |
| M | ? | _known_annotated_metadata.py | 267 |
...
| H | ? | mkdocs.yml | 0 |
| s | GS009 |  | 0 |
| H | GS014 | networks.py | 773 |
| H | GS014 | networks.py | 775 |
| H | GS014 | networks.py | 778 |
| H | GS014 | networks.py | 786 |
| H | GS014 | networks.py | 786 |
| M | ? | shared.py | 8 |
| H | ? | lookup_key.rs | 184 |
| H | ? | lookup_key.rs | 193 |
...
---
*Сгенерировано GSC v0.6 · 2026-08-01T04:02:46.537555*