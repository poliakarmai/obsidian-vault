...
**Дата:** 19.07.2026 04:07  
**Путь:** `/tmp/gsc-learn/polars`  
**Всего находок:** 7434  
**CRITICAL:** 19 | **HIGH:** 6705 | **MEDIUM:** 52 | **LOW:** 657

## 📊 По детекторам

| Детектор | Находок |
|----------|--------|
| Rust: .clone() in hot path | 6675 |
| GS003 | 355 |
...
| CRITICAL | ? | _executor.py | 494 | Match:         param_key = "parameters" |
...
| HIGH | GS004 | various.py | 680 | Line 680: subprocess.run(cmd, shell=True) |
...
| HIGH | ? | mod.rs | 79 | Clone in performance-critical code — consider references |
| HIGH | ? | mod.rs | 87 | Clone in performance-critical code — consider references |
| HIGH | ? | equi_join.rs | 94 | Clone in performance-critical code — consider references |
| HIGH | ? | equi_join.rs | 99 | Clone in performance-critical code — consider references |
| HIGH | ? | equi_join.rs | 105 | Clone in performance-critical code — consider references |
| HIGH | ? | equi_join.rs | 116 | Clone in performance-critical code — consider references |
| HIGH | ? | equi_join.rs | 153 | Clone in performance-critical code — consider references |
| HIGH | ? | equi_join.rs | 160 | Clone in performance-critical code — consider references |
| HIGH | ? | equi_join.rs | 174 | Clone in performance-critical code — consider references |
| HIGH | ? | equi_join.rs | 191 | Clone in performance-critical code — consider references |
| HIGH | ? | equi_join.rs | 203 | Clone in performance-critical code — consider references |
| HIGH | ? | equi_join.rs | 420 | Clone in performance-critical code — consider references |
| HIGH | ? | equi_join.rs | 506 | Clone in performance-critical code — consider references |
| HIGH | ? | equi_join.rs | 564 | Clone in performance-critical code — consider references |
| HIGH | ? | equi_join.rs | 654 | Clone in performance-critical code — consider references |
| HIGH | ? | equi_join.rs | 655 | Clone in performance-critical code — consider references |
| HIGH | ? | equi_join.rs | 676 | Clone in performance-critical code — consider references |
| HIGH | ? | equi_join.rs | 811 | Clone in performance-critical code — consider references |
| HIGH | ? | equi_join.rs | 812 | Clone in performance-critical code — consider references |
| HIGH | ? | equi_join.rs | 859 | Clone in performance-critical code — consider references |
| HIGH | ? | equi_join.rs | 1061 | Clone in performance-critical code — consider references |
| HIGH | ? | equi_join.rs | 1169 | Clone in performance-critical code — consider references |
| HIGH | ? | equi_join.rs | 1500 | Clone in performance-critical code — consider references |
| HIGH | ? | equi_join.rs | 1501 | Clone in performance-critical code — consider references |
| HIGH | ? | equi_join.rs | 1532 | Clone in performance-critical code — consider references |
| HIGH | ? | equi_join.rs | 1565 | Clone in performance-critical code — consider references |
...
| HIGH | ? | semi_anti_join.rs | 182 | Clone in performance-critical code — consider references |
| HIGH | ? | semi_anti_join.rs | 183 | Clone in performance-critical code — consider references |
| HIGH | ? | semi_anti_join.rs | 305 | Clone in performance-critical code — consider references |
| HIGH | ? | semi_anti_join.rs | 322 | Clone in performance-critical code — consider references |
| HIGH | ? | semi_anti_join.rs | 435 | Clone in performance-critical code — consider references |
| HIGH | ? | semi_anti_join.rs | 455 | Clone in performance-critical code — consider references |
...
| HIGH | ? | mod.rs | 782 | Clone in performance-critical code — consider references |
...
| HIGH | ? | mod.rs | 825 | Clone in performance-critical code — consider references |
...
| HIGH | ? | lower_expr.rs | 2491 | Clone in performance-critical code — consider references |
| HIGH | ? | lower_expr.rs | 2497 | Clone in performance-critical code — consider references |
| HIGH | ? | lower_expr.rs | 2533 | Clone in performance-critical code — consider references |
| HIGH | ? | lower_expr.rs | 2540 | Clone in performance-critical code — consider references |
| HIGH | ? | lower_expr.rs | 2545 | Clone in performance-critical code — consider references |
| HIGH | ? | lower_expr.rs | 2546 | Clone in performance-critical code — consider references |
| HIGH | ? | lower_expr.rs | 2557 | Clone in performance-critical code — consider references |
| HIGH | ? | lower_expr.rs | 2566 | Clone in performance-critical code — consider references |
| HIGH | ? | lower_expr.rs | 2567 | Clone in performance-critical code — consider references |
| HIGH | ? | lower_expr.rs | 2581 | Clone in performance-critical code — consider references |
| HIGH | ? | lower_expr.rs | 2603 | Clone in performance-critical code — consider references |
| HIGH | ? | lower_expr.rs | 2630 | Clone in performance-critical code — consider references |
| HIGH | ? | lower_expr.rs | 2639 | Clone in performance-critical code — consider references |
| HIGH | ? | lower_expr.rs | 2643 | Clone in performance-critical code — consider references |
| HIGH | ? | lower_expr.rs | 2653 | Clone in performance-critical code — consider references |
| HIGH | ? | lower_expr.rs | 2663 | Clone in performance-critical code — consider references |
| HIGH | ? | lower_expr.rs | 2709 | Clone in performance-critical code — consider references |
| HIGH | ? | lower_expr.rs | 2712 | Clone in performance-critical code — consider references |
| HIGH | ? | lower_expr.rs | 2750 | Clone in performance-critical code — consider references |
| HIGH | ? | lower_expr.rs | 2756 | Clone in performance-critical code — consider references |
| HIGH | ? | lower_expr.rs | 2779 | Clone in performance-critical code — consider references |
| HIGH | ? | lower_expr.rs | 2819 | Clone in performance-critical code — consider references |
| HIGH | ? | lower_expr.rs | 2860 | Clone in performance-critical code — consider references |
| HIGH | ? | lower_expr.rs | 2863 | Clone in performance-critical code — consider references |
| HIGH | ? | lower_expr.rs | 2865 | Clone in performance-critical code — consider references |
| HIGH | ? | lower_expr.rs | 2885 | Clone in performance-critical code — consider references |
| HIGH | ? | lower_expr.rs | 2886 | Clone in performance-critical code — consider references |
| HIGH | ? | lower_expr.rs | 2888 | Clone in performance-critical code — consider references |
| HIGH | ? | lower_expr.rs | 2893 | Clone in performance-critical code — consider references |
| HIGH | ? | lower_expr.rs | 2938 | Clone in performance-critical code — consider references |
...
| HIGH | ? | to_graph.rs | 1154 | Clone in performance-critical code — consider references |
| HIGH | ? | to_graph.rs | 1155 | Clone in performance-critical code — consider references |
| HIGH | ? | to_graph.rs | 1247 | Clone in performance-critical code — consider references |
| HIGH | ? | to_graph.rs | 1250 | Clone in performance-critical code — consider references |
| HIGH | ? | to_graph.rs | 1251 | Clone in performance-critical code — consider references |
| HIGH | ? | to_graph.rs | 1252 | Clone in performance-critical code — consider references |
| HIGH | ? | to_graph.rs | 1259 | Clone in performance-critical code — consider references |
| HIGH | ? | to_graph.rs | 1260 | Clone in performance-critical code — consider references |
| HIGH | ? | to_graph.rs | 1261 | Clone in performance-critical code — consider references |
| HIGH | ? | to_graph.rs | 1262 | Clone in performance-critical code — consider references |
| HIGH | ? | to_graph.rs | 1280 | Clone in performance-critical code — consider references |
| HIGH | ? | to_graph.rs | 1283 | Clone in performance-critical code — consider references |
| HIGH | ? | to_graph.rs | 1284 | Clone in performance-critical code — consider references |
| HIGH | ? | to_graph.rs | 1310 | Clone in performance-critical code — consider references |
| HIGH | ? | to_graph.rs | 1313 | Clone in performance-critical code — consider references |
| HIGH | ? | to_graph.rs | 1314 | Clone in performance-critical code — consider references |
| HIGH | ? | to_graph.rs | 1322 | Clone in performance-critical code — consider references |
| HIGH | ? | to_graph.rs | 1323 | Clone in performance-critical code — consider references |
| HIGH | ? | to_graph.rs | 1324 | Clone in performance-critical code — consider references |
...
| HIGH | ? | to_graph.rs | 1354 | Clone in performance-critical code — consider references |
| HIGH | ? | to_graph.rs | 1355 | Clone in performance-critical code — consider references |
| HIGH | ? | to_graph.rs | 1358 | Clone in performance-critical code — consider references |
| HIGH | ? | to_graph.rs | 1359 | Clone in performance-critical code — consider references |
| HIGH | ? | to_graph.rs | 1364 | Clone in performance-critical code — consider references |
| HIGH | ? | to_graph.rs | 1365 | Clone in performance-critical code — consider references |
| HIGH | ? | to_graph.rs | 1366 | Clone in performance-critical code — consider references |
| HIGH | ? | to_graph.rs | 1367 | Clone in performance-critical code — consider references |
| HIGH | ? | to_graph.rs | 1402 | Clone in performance-critical code — consider references |
| HIGH | ? | to_graph.rs | 1421 | Clone in performance-critical code — consider references |
| HIGH | ? | to_graph.rs | 1444 | Clone in performance-critical code — consider references |
| HIGH | ? | to_graph.rs | 1451 | Clone in performance-critical code — consider references |
| HIGH | ? | to_graph.rs | 1471 | Clone in performance-critical code — consider references |
| HIGH | ? | to_graph.rs | 1527 | Clone in performance-critical code — consider references |
| HIGH | ? | to_graph.rs | 1560 | Clone in performance-critical code — consider references |
| HIGH | ? | to_graph.rs | 1564 | Clone in performance-critical code — consider references |
| HIGH | ? | to_graph.rs | 1579 | Clone in performance-critical code — consider references |
...
| HIGH | ? | sink.rs | 418 | Clone in performance-critical code — consider references |
| HIGH | ? | sink.rs | 422 | Clone in performance-critical code — consider references |
| HIGH | ? | sink.rs | 426 | Clone in performance-critical code — consider references |
| HIGH | ? | sink.rs | 518 | Clone in performance-critical code — consider references |
...
| HIGH | ? | scan_sources.rs | 88 | Clone in performance-critical code — consider references |
| HIGH | ? | scan_sources.rs | 97 | Clone in performance-critical code — consider references |
| HIGH | ? | scan_sources.rs | 201 | Clone in performance-critical code — consider references |
| HIGH | ? | scan_sources.rs | 237 | Clone in performance-critical code — consider references |
| HIGH | ? | scan_sources.rs | 264 | Clone in performance-critical code — consider references |
| HIGH | ? | scan_sources.rs | 357 | Clone in performance-critical code — consider references |
| HIGH | ? | scan_sources.rs | 358 | Clone in performance-critical code — consider references |
| HIGH | ? | scan_sources.rs | 377 | Clone in performance-critical code — consider references |
| HIGH | ? | scan_sources.rs | 385 | Clone in performance-critical code — consider references |
| HIGH | ? | scan_sources.rs | 417 | Clone in performance-critical code — consider references |
| HIGH | ? | scan_sources.rs | 429 | Clone in performance-critical code — consider references |
| HIGH | ? | scan_sources.rs | 454 | Clone in performance-critical code — consider references |
| HIGH | ? | scan_sources.rs | 490 | Clone in performance-critical code — consider references |
| HIGH | ? | scan_sources.rs | 503 | Clone in performance-critical code — consider references |
| HIGH | ? | scan_sources.rs | 509 | Clone in performance-critical code — consider references |
...
| HIGH | ? | lit.rs | 129 | Clone in performance-critical code — consider references |
| HIGH | ? | lit.rs | 215 | Clone in performance-critical code — consider references |
| HIGH | ? | lit.rs | 300 | Clone in performance-critical code — consider references |
| HIGH | ? | lit.rs | 302 | Clone in performance-critical code — consider references |
| HIGH | ? | lit.rs | 325 | Clone in performance-critical code — consider references |
| HIGH | ? | lit.rs | 326 | Clone in performance-critical code — consider references |
| HIGH | ? | lit.rs | 327 | Clone in performance-critical code — consider references |
| HIGH | ? | lit.rs | 387 | Clone in performance-critical code — consider references |
| HIGH | ? | lit.rs | 392 | Clone in performance-critical code — consider references |
| HIGH | ? | hive.rs | 107 | Clone in performance-critical code — consider references |
| HIGH | ? | hive.rs | 125 | Clone in performance-critical code — consider references |
| HIGH | ? | hive.rs | 128 | Clone in performance-critical code — consider references |
...
| HIGH | ? | expand_datasets.rs | 66 | Clone in performance-critical code — consider references |
| HIGH | ? | expand_datasets.rs | 78 | Clone in performance-critical code — consider references |
| HIGH | ? | expand_datasets.rs | 218 | Clone in performance-critical code — consider references |
| HIGH | ? | expand_datasets.rs | 325 | Clone in performance-critical code — consider references |
| HIGH | ? | expand_datasets.rs | 328 | Clone in performance-critical code — consider references |
| HIGH | ? | expand_datasets.rs | 331 | Clone in performance-critical code — consider references |
| HIGH | ? | expand_datasets.rs | 332 | Clone in performance-critical code — consider references |
| HIGH | ? | expand_datasets.rs | 333 | Clone in performance-critical code — consider references |
| HIGH | ? | expand_datasets.rs | 334 | Clone in performance-critical code — consider references |
| HIGH | ? | expand_datasets.rs | 369 | Clone in performance-critical code — consider references |
| HIGH | ? | expand_datasets.rs | 371 | Clone in performance-critical code — consider references |
| HIGH | ? | expand_datasets.rs | 422 | Clone in performance-critical code — consider references |
| HIGH | ? | expand_datasets.rs | 440 | Clone in performance-critical code — consider references |
| HIGH | ? | expand_datasets.rs | 441 | Clone in performance-critical code — consider references |
| HIGH | ? | mod.rs | 162 | Clone in performance-critical code — consider references |
| HIGH | ? | mod.rs | 264 | Clone in performance-critical code — consider references |
| HIGH | ? | mod.rs | 270 | Clone in performance-critical code — consider references |
| HIGH | ? | mod.rs | 361 | Clone in performance-critical code — consider references |
| HIGH | ? | mod.rs | 424 | Clone in performance-critical code — consider references |
| HIGH | ? | mod.rs | 219 | Clone in performance-critical code — consider references |
| HIGH | ? | mod.rs | 258 | Clone in performance-critical code — consider references |
| HIGH | ? | mod.rs | 274 | Clone in performance-critical code — consider references |
| HIGH | ? | mod.rs | 279 | Clone in performance-critical code — consider references |
| HIGH | ? | mod.rs | 376 | Clone in performance-critical code — consider references |
| HIGH | ? | mod.rs | 380 | Clone in performance-critical code — consider references |
...
| HIGH | ? | predicate_pruning.rs | 253 | Clone in performance-critical code — consider references |
| HIGH | ? | predicate_pruning.rs | 300 | Clone in performance-critical code — consider references |
| HIGH | ? | predicate_pruning.rs | 550 | Clone in performance-critical code — consider references |
| HIGH | ? | predicate_pruning.rs | 619 | Clone in performance-critical code — consider references |
| HIGH | ? | predicate_pruning.rs | 646 | Clone in performance-critical code — consider references |
| HIGH | ? | predicate_pruning.rs | 711 | Clone in performance-critical code — consider references |
| HIGH | ? | predicate_pruning.rs | 714 | Clone in performance-critical code — consider references |
| HIGH | ? | predicate_pruning.rs | 715 | Clone in performance-critical code — consider references |
| HIGH | ? | predicate_pruning.rs | 717 | Clone in performance-critical code — consider references |
| HIGH | ? | predicate_pruning.rs | 724 | Clone in performance-critical code — consider references |
| HIGH | ? | predicate_pruning.rs | 725 | Clone in performance-critical code — consider references |
| HIGH | ? | predicate_pruning.rs | 740 | Clone in performance-critical code — consider references |
| HIGH | ? | predicate_pruning.rs | 746 | Clone in performance-critical code — consider references |
| HIGH | ? | predicate_pruning.rs | 751 | Clone in performance-critical code — consider references |
| HIGH | ? | predicate_pruning.rs | 758 | Clone in performance-critical code — consider references |
| HIGH | ? | predicate_pruning.rs | 759 | Clone in performance-critical code — consider references |
| HIGH | ? | predicate_pruning.rs | 764 | Clone in performance-critical code — consider references |
| HIGH | ? | predicate_pruning.rs | 844 | Clone in performance-critical code — consider references |
| HIGH | ? | predicate_pruning.rs | 847 | Clone in performance-critical code — consider references |
| HIGH | ? | predicate_pruning.rs | 848 | Clone in performance-critical code — consider references |
| HIGH | ? | predicate_pruning.rs | 853 | Clone in performance-critical code — consider references |
| HIGH | ? | predicate_pruning.rs | 861 | Clone in performance-critical code — consider references |
| HIGH | ? | predicate_pruning.rs | 862 | Clone in performance-critical code — consider references |
| HIGH | ? | predicate_pruning.rs | 864 | Clone in performance-critical code — consider references |
| HIGH | ? | predicate_pruning.rs | 867 | Clone in performance-critical code — consider references |
| HIGH | ? | predicate_pruning.rs | 874 | Clone in performance-critical code — consider references |
| HIGH | ? | predicate_pruning.rs | 876 | Clone in performance-critical code — consider references |
| HIGH | ? | predicate_pruning.rs | 896 | Clone in performance-critical code — consider references |
| HIGH | ? | predicate_pruning.rs | 901 | Clone in performance-critical code — consider references |
| HIGH | ? | predicate_pruning.rs | 910 | Clone in performance-critical code — consider references |
| HIGH | ? | hive.rs | 11 | Clone in performance-critical code — consider references |
| HIGH | ? | hive.rs | 79 | Clone in performance-critical code — consider references |
| HIGH | ? | hive.rs | 90 | Clone in performance-critical code — consider references |
| HIGH | ? | hive.rs | 96 | Clone in performance-critical code — consider references |
| HIGH | ? | hive.rs | 105 | Clone in performance-critical code — consider references |
| HIGH | ? | hive.rs | 113 | Clone in performance-critical code — consider references |
| HIGH | ? | hive.rs | 115 | Clone in performance-critical code — consider references |
| HIGH | ? | hive.rs | 118 | Clone in performance-critical code — consider references |
| HIGH | ? | hive.rs | 120 | Clone in performance-critical code — consider references |
| HIGH | ? | hive.rs | 126 | Clone in performance-critical code — consider references |
| HIGH | ? | hive.rs | 127 | Clone in performance-critical code — consider references |
| HIGH | ? | hive.rs | 128 | Clone in performance-critical code — consider references |
| HIGH | ? | hive.rs | 129 | Clone in performance-critical code — consider references |
| HIGH | ? | hive.rs | 162 | Clone in performance-critical code — consider references |
| HIGH | ? | hive.rs | 163 | Clone in performance-critical code — consider references |
| HIGH | ? | hive.rs | 164 | Clone in performance-critical code — consider references |
| HIGH | ? | hive.rs | 165 | Clone in performance-critical code — consider references |
| HIGH | ? | hive.rs | 184 | Clone in performance-critical code — consider references |
| HIGH | ? | hive.rs | 185 | Clone in performance-critical code — consider references |
| HIGH | ? | hive.rs | 186 | Clone in performance-critical code — consider references |
| HIGH | ? | hive.rs | 187 | Clone in performance-critical code — consider references |
...
| HIGH | ? | csee.rs | 140 | Clone in performance-critical code — consider references |
| HIGH | ? | csee.rs | 541 | Clone in performance-critical code — consider references |
| HIGH | ? | csee.rs | 546 | Clone in performance-critical code — consider references |
| HIGH | ? | csee.rs | 674 | Clone in performance-critical code — consider references |
| HIGH | ? | csee.rs | 856 | Clone in performance-critical code — consider references |
| HIGH | ? | csee.rs | 903 | Clone in performance-critical code — consider references |
| HIGH | ? | csee.rs | 916 | Clone in performance-critical code — consider references |
| HIGH | ? | csee.rs | 928 | Clone in performance-critical code — consider references |
| HIGH | ? | csee.rs | 994 | Clone in performance-critical code — consider references |
| HIGH | ? | csee.rs | 1039 | Clone in performance-critical code — consider references |
| HIGH | ? | csee.rs | 1087 | Clone in performance-critical code — consider references |
| HIGH | ? | csee.rs | 1088 | Clone in performance-critical code — consider references |
| HIGH | ? | csee.rs | 1089 | Clone in performance-critical code — consider references |
| HIGH | ? | csee.rs | 1090 | Clone in performance-critical code — consider references |
...
| HIGH | ? | simplify_functions.rs | 227 | Clone in performance-critical code — consider references |
| HIGH | ? | simplify_functions.rs | 237 | Clone in performance-critical code — consider references |
| HIGH | ? | simplify_functions.rs | 348 | Clone in performance-critical code — consider references |
...
| HIGH | ? | expr.rs | 369 | Clone in performance-critical code — consider references |
...
| HIGH | ? | mod.rs | 720 | Clone in performance-critical code — consider references |
| HIGH | ? | mod.rs | 800 | Clone in performance-critical code — consider references |
| HIGH | ? | mod.rs | 801 | Clone in performance-critical code — consider references |
...
| HIGH | ? | mod.rs | 903 | Clone in performance-critical code — consider references |
| HIGH | ? | mod.rs | 904 | Clone in performance-critical code — consider references |
| HIGH | ? | mod.rs | 954 | Clone in performance-critical code — consider references |
| HIGH | ? | mod.rs | 955 | Clone in performance-critical code — consider references |
| HIGH | ? | mod.rs | 1003 | Clone in performance-critical code — consider references |
| HIGH | ? | mod.rs | 1004 | Clone in performance-critical code — consider references |
| HIGH | ? | mod.rs | 1042 | Clone in performance-critical code — consider references |
| HIGH | ? | mod.rs | 1043 | Clone in performance-critical code — consider references |
| HIGH | ? | mod.rs | 1103 | Clone in performance-critical code — consider references |
...
| HIGH | ? | mod.rs | 1155 | Clone in performance-critical code — consider references |
| HIGH | ? | mod.rs | 1156 | Clone in performance-critical code — consider references |
| HIGH | ? | mod.rs | 1198 | Clone in performance-critical code — consider references |
| HIGH | ? | mod.rs | 1199 | Clone in performance-critical code — consider references |
| HIGH | ? | mod.rs | 1229 | Clone in performance-critical code — consider references |
| HIGH | ? | mod.rs | 1230 | Clone in performance-critical code — consider references |
| HIGH | ? | mod.rs | 1307 | Clone in performance-critical code — consider references |
...
| HIGH | ? | mod.rs | 1384 | Clone in performance-critical code — consider references |
...
| HIGH | ? | mod.rs | 1458 | Clone in performance-critical code — consider references |
| HIGH | ? | mod.rs | 1465 | Clone in performance-critical code — consider references |
| HIGH | ? | mod.rs | 1492 | Clone in performance-critical code — consider references |
| HIGH | ? | mod.rs | 1501 | Clone in performance-critical code — consider references |
| HIGH | ? | mod.rs | 1507 | Clone in performance-critical code — consider references |
| HIGH | ? | mod.rs | 1557 | Clone in performance-critical code — consider references |
| HIGH | ? | mod.rs | 1564 | Clone in performance-critical code — consider references |
| HIGH | ? | mod.rs | 1567 | Clone in performance-critical code — consider references |
| HIGH | ? | mod.rs | 1623 | Clone in performance-critical code — consider references |
| HIGH | ? | mod.rs | 1634 | Clone in performance-critical code — consider references |
...
| HIGH | ? | binary.rs | 279 | Clone in performance-critical code — consider references |
| HIGH | ? | binary.rs | 280 | Clone in performance-critical code — consider references |
| HIGH | ? | binary.rs | 286 | Clone in performance-critical code — consider references |
| HIGH | ? | binary.rs | 359 | Clone in performance-critical code — consider references |
| HIGH | ? | binary.rs | 516 | Clone in performance-critical code — consider references |
| HIGH | ? | binary.rs | 600 | Clone in performance-critical code — consider references |
| HIGH | ? | binary.rs | 611 | Clone in performance-critical code — consider references |
| HIGH | ? | binary.rs | 650 | Clone in performance-critical code — consider references |
| HIGH | ? | binary.rs | 660 | Clone in performance-critical code — consider references |
...
| HIGH | ? | scans.rs | 631 | Clone in performance-critical code — consider references |
| HIGH | ? | scans.rs | 638 | Clone in performance-critical code — consider references |
| HIGH | ? | scans.rs | 677 | Clone in performance-critical code — consider references |
| HIGH | ? | scans.rs | 682 | Clone in performance-critical code — consider references |
| HIGH | ? | scans.rs | 704 | Clone in performance-critical code — consider references |
| HIGH | ? | scans.rs | 714 | Clone in performance-critical code — consider references |
| HIGH | ? | scans.rs | 741 | Clone in performance-critical code — consider references |
| HIGH | ? | scans.rs | 826 | Clone in performance-critical code — consider references |
| HIGH | ? | scans.rs | 829 | Clone in performance-critical code — consider references |
| HIGH | ? | scans.rs | 860 | Clone in performance-critical code — consider references |
| HIGH | ? | scans.rs | 861 | Clone in performance-critical code — consider references |
| HIGH | ? | scans.rs | 865 | Clone in performance-critical code — consider references |
| HIGH | ? | scans.rs | 890 | Clone in performance-critical code — consider references |
| HIGH | ? | scans.rs | 897 | Clone in performance-critical code — consider references |
| HIGH | ? | scans.rs | 910 | Clone in performance-critical code — consider references |
| HIGH | ? | scans.rs | 924 | Clone in performance-critical code — consider references |
| HIGH | ? | scans.rs | 943 | Clone in performance-critical code — consider references |
| HIGH | ? | scans.rs | 963 | Clone in performance-critical code — consider references |
| HIGH | ? | scans.rs | 974 | Clone in performance-critical code — consider references |
| HIGH | ? | scans.rs | 1042 | Clone in performance-critical code — consider references |
| HIGH | ? | scans.rs | 1112 | Clone in performance-critical code — consider references |
| HIGH | ? | scans.rs | 1207 | Clone in performance-critical code — consider references |
| HIGH | ? | scans.rs | 1209 | Clone in performance-critical code — consider references |
| HIGH | ? | scans.rs | 1244 | Clone in performance-critical code — consider references |
| HIGH | ? | scans.rs | 1246 | Clone in performance-critical code — consider references |
| HIGH | ? | scans.rs | 1295 | Clone in performance-critical code — consider references |
| HIGH | ? | scans.rs | 1298 | Clone in performance-critical code — consider references |
| HIGH | ? | scans.rs | 1317 | Clone in performance-critical code — consider references |
| HIGH | ? | scans.rs | 1321 | Clone in performance-critical code — consider references |
| HIGH | ? | scans.rs | 1322 | Clone in performance-critical code — consider references |
| HIGH | ? | scans.rs | 1329 | Clone in performance-critical code — consider references |
| HIGH | ? | scans.rs | 1333 | Clone in performance-critical code — consider references |
| HIGH | ? | scans.rs | 1334 | Clone in performance-critical code — consider references |
| HIGH | ? | scans.rs | 1367 | Clone in performance-critical code — consider references |
| HIGH | ? | scans.rs | 1372 | Clone in performance-critical code — consider references |
| HIGH | ? | scans.rs | 1387 | Clone in performance-critical code — consider references |
| HIGH | ? | scans.rs | 1388 | Clone in performance-critical code — consider references |
| HIGH | ? | scans.rs | 1398 | Clone in performance-critical code — consider references |
| HIGH | ? | scans.rs | 1409 | Clone in performance-critical code — consider references |
| HIGH | ? | scans.rs | 1410 | Clone in performance-critical code — consider references |
...
| HIGH | ? | scans.rs | 1421 | Clone in performance-critical code — consider references |
| HIGH | ? | scans.rs | 1422 | Clone in performance-critical code — consider references |
| HIGH | ? | scans.rs | 1423 | Clone in performance-critical code — consider references |
| HIGH | ? | scans.rs | 1433 | Clone in performance-critical code — consider references |
| HIGH | ? | scans.rs | 1452 | Clone in performance-critical code — consider references |
| HIGH | ? | scans.rs | 1460 | Clone in performance-critical code — consider references |
...
| HIGH | ? | functions.rs | 1099 | Clone in performance-critical code — consider references |
| HIGH | ? | functions.rs | 1108 | Clone in performance-critical code — consider references |
| HIGH | ? | functions.rs | 1139 | Clone in performance-critical code — consider references |
| HIGH | ? | functions.rs | 1161 | Clone in performance-critical code — consider references |
...
| HIGH | ? | schema.rs | 439 | Clone in performance-critical code — consider references |
| HIGH | ? | schema.rs | 443 | Clone in performance-critical code — consider references |
| HIGH | ? | schema.rs | 462 | Clone in performance-critical code — consider references |
| HIGH | ? | schema.rs | 484 | Clone in performance-critical code — consider references |
| HIGH | ? | schema.rs | 489 | Clone in performance-critical code — consider references |
| HIGH | ? | schema.rs | 495 | Clone in performance-critical code — consider references |
| HIGH | ? | schema.rs | 516 | Clone in performance-critical code — consider references |
| HIGH | ? | schema.rs | 541 | Clone in performance-critical code — consider references |
| HIGH | ? | schema.rs | 543 | Clone in performance-critical code — consider references |
| HIGH | ? | schema.rs | 545 | Clone in performance-critical code — consider references |
| HIGH | ? | schema.rs | 550 | Clone in performance-critical code — consider references |
| HIGH | ? | schema.rs | 587 | Clone in performance-critical code — consider references |
| HIGH | ? | schema.rs | 603 | Clone in performance-critical code — consider references |
| HIGH | ? | schema.rs | 611 | Clone in performance-critical code — consider references |
| HIGH | ? | schema.rs | 625 | Clone in performance-critical code — consider references |
| HIGH | ? | schema.rs | 632 | Clone in performance-critical code — consider references |
| HIGH | ? | schema.rs | 657 | Clone in performance-critical code — consider references |
| HIGH | ? | schema.rs | 673 | Clone in performance-critical code — consider references |
| HIGH | ? | schema.rs | 679 | Clone in performance-critical code — consider references |
| HIGH | ? | schema.rs | 707 | Clone in performance-critical code — consider references |
| HIGH | ? | schema.rs | 712 | Clone in performance-critical code — consider references |
| HIGH | ? | schema.rs | 730 | Clone in performance-critical code — consider references |
| HIGH | ? | schema.rs | 760 | Clone in performance-critical code — consider references |
| HIGH | ? | schema.rs | 773 | Clone in performance-critical code — consider references |
| HIGH | ? | schema.rs | 795 | Clone in performance-critical code — consider references |
| HIGH | ? | schema.rs | 821 | Clone in performance-critical code — consider references |
| HIGH | ? | schema.rs | 828 | Clone in performance-critical code — consider references |
...
| HIGH | ? | csv.rs | 166 | Clone in performance-critical code — consider references |
| HIGH | ? | csv.rs | 191 | Clone in performance-critical code — consider references |
| HIGH | ? | csv.rs | 290 | Clone in performance-critical code — consider references |
| HIGH | ? | csv.rs | 325 | Clone in performance-critical code — consider references |
| HIGH | ? | csv.rs | 335 | Clone in performance-critical code — consider references |
...
| HIGH | ? | file_metadata.rs | 141 | Clone in performance-critical code — consider references |
| HIGH | ? | file_metadata.rs | 171 | Clone in performance-critical code — consider references |
...
| HIGH | ? | ewm.rs | 30 | Clone in performance-critical code — consider references |
| HIGH | ? | ewm.rs | 41 | Clone in performance-critical code — consider references |
| HIGH | ? | ewm.rs | 52 | Clone in performance-critical code — consider references |
| HIGH | ? | ewm.rs | 75 | Clone in performance-critical code — consider references |
| HIGH | ? | ewm.rs | 87 | Clone in performance-critical code — consider references |
| HIGH | ? | ewm.rs | 99 | Clone in performance-critical code — consider references |
| HIGH | ? | ewm.rs | 121 | Clone in performance-critical code — consider references |
| HIGH | ? | ewm.rs | 133 | Clone in performance-critical code — consider references |
| HIGH | ? | ewm.rs | 145 | Clone in performance-critical code — consider references |
...
| HIGH | ? | ewm_by.rs | 151 | Clone in performance-critical code — consider references |
| HIGH | ? | ewm_by.rs | 200 | Clone in performance-critical code — consider references |
...
| HIGH | ? | mod.rs | 665 | Clone in performance-critical code — consider references |
...
| HIGH | ? | sql.rs | 17 | Clone in performance-critical code — consider references |
...
| HIGH | ? | expr_nodes.rs | 666 | Clone in performance-critical code — consider references |
| HIGH | ? | expr_nodes.rs | 674 | Clone in performance-critical code — consider references |
| HIGH | ? | expr_nodes.rs | 735 | Clone in performance-critical code — consider references |
| HIGH | ? | expr_nodes.rs | 756 | Clone in performance-critical code — consider references |
| HIGH | ? | expr_nodes.rs | 794 | Clone in performance-critical code — consider references |
| HIGH | ? | expr_nodes.rs | 795 | Clone in performance-critical code — consider references |
| HIGH | ? | expr_nodes.rs | 998 | Clone in performance-critical code — consider references |
| HIGH | ? | expr_nodes.rs | 1657 | Clone in performance-critical code — consider references |
| HIGH | ? | nodes.rs | 101 | Clone in performance-critical code — consider references |
| HIGH | ? | nodes.rs | 458 | Clone in performance-critical code — consider references |
| HIGH | ? | nodes.rs | 472 | Clone in performance-critical code — consider references |
| HIGH | ? | nodes.rs | 483 | Clone in performance-critical code — consider references |
| HIGH | ? | nodes.rs | 520 | Clone in performance-critical code — consider references |
| HIGH | ? | nodes.rs | 521 | Clone in performance-critical code — consider references |
| HIGH | ? | nodes.rs | 551 | Clone in performance-critical code — consider references |
...
| HIGH | ? | general.rs | 47 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 290 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 511 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 533 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 549 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 560 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 571 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 577 | Clone in performance-critical code — consider references |
...
| HIGH | ? | general.rs | 632 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 672 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 675 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 722 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 761 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 834 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 866 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 882 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 896 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 907 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 911 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 916 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 922 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 928 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 948 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 984 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 1008 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 1035 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 1086 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 1116 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 1130 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 1136 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 1141 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 1252 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 1260 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 1267 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 1274 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 1279 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 1285 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 1294 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 1299 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 1305 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 1311 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 1317 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 1323 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 1329 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 1335 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 1341 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 1349 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 1361 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 1372 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 1384 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 1392 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 1399 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 1404 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 1421 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 1424 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 1451 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 1457 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 1480 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 1491 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 1496 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 1497 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 1501 | Clone in performance-critical code — consider references |
...
| HIGH | ? | general.rs | 1529 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 1538 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 1598 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 1633 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 1641 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 1674 | Clone in performance-critical code — consider references |
...
| HIGH | ? | general.rs | 849 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 869 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 886 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 890 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 896 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 899 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 902 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 906 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 910 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 914 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 918 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 922 | Clone in performance-critical code — consider references |
...
| HIGH | ? | general.rs | 935 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 947 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 968 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 979 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 995 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 1012 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 1024 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 1045 | Clone in performance-critical code — consider references |
| HIGH | ? | general.rs | 1061 | Clone in performance-critical code — consider references |
...
| HIGH | ? | mod.rs | 274 | Clone in performance-critical code — consider references |
| HIGH | ? | mod.rs | 367 | Clone in performance-critical code — consider references |
| HIGH | ? | mod.rs | 381 | Clone in performance-critical code — consider references |
| HIGH | ? | mod.rs | 417 | Clone in performance-critical code — consider references |
| HIGH | ? | mod.rs | 485 | Clone in performance-critical code — consider references |
| HIGH | ? | mod.rs | 494 | Clone in performance-critical code — consider references |
| HIGH | ? | mod.rs | 509 | Clone in performance-critical code — consider references |
| HIGH | ? | mod.rs | 611 | Clone in performance-critical code — consider references |
| HIGH | ? | mod.rs | 636 | Clone in performance-critical code — consider references |
...
| HIGH | ? | mod.rs | 746 | Clone in performance-critical code — consider references |
| HIGH | ? | mod.rs | 767 | Clone in performance-critical code — consider references |
| HIGH | ? | mod.rs | 787 | Clone in performance-critical code — consider references |
| HIGH | ? | mod.rs | 799 | Clone in performance-critical code — consider references |
| HIGH | ? | mod.rs | 810 | Clone in performance-critical code — consider references |
| HIGH | ? | mod.rs | 811 | Clone in performance-critical code — consider references |
| HIGH | ? | mod.rs | 854 | Clone in performance-critical code — consider references |
| HIGH | ? | mod.rs | 981 | Clone in performance-critical code — consider references |
| HIGH | ? | mod.rs | 982 | Clone in performance-critical code — consider references |
| HIGH | ? | mod.rs | 983 | Clone in performance-critical code — consider references |
...
| HIGH | ? | categorical.rs | 301 | Clone in performance-critical code — consider references |
...
| HIGH | ? | options.rs | 115 | Clone in performance-critical code — consider references |
| HIGH | ? | schema_inference.rs | 206 | Clone in performance-critical code — consider references |
| HIGH | ? | schema_inference.rs | 220 | Clone in performance-critical code — consider references |
| HIGH | ? | schema_inference.rs | 234 | Clone in performance-critical code — consider references |
...
| HIGH | ? | streaming.rs | 801 | Clone in performance-critical code — consider references |
| HIGH | ? | streaming.rs | 806 | Clone in performance-critical code — consider references |
| HIGH | ? | streaming.rs | 817 | Clone in performance-critical code — consider references |
| HIGH | ? | streaming.rs | 826 | Clone in performance-critical code — consider references |
...
| HIGH | ? | replace.rs | 136 | Clone in performance-critical code — consider references |
| HIGH | ? | replace.rs | 137 | Clone in performance-critical code — consider references |
| HIGH | ? | replace.rs | 185 | Clone in performance-critical code — consider references |
...
| HIGH | ? | functions.rs | 491 | Clone in performance-critical code — consider references |
| HIGH | ? | functions.rs | 496 | Clone in performance-critical code — consider references |
| HIGH | ? | functions.rs | 500 | Clone in performance-critical code — consider references |
| HIGH | ? | functions.rs | 509 | Clone in performance-critical code — consider references |
| HIGH | ? | functions.rs | 516 | Clone in performance-critical code — consider references |
| HIGH | ? | functions.rs | 538 | Clone in performance-critical code — consider references |
| HIGH | ? | functions.rs | 577 | Clone in performance-critical code — consider references |
| HIGH | ? | functions.rs | 599 | Clone in performance-critical code — consider references |
...
| HIGH | ? | context.rs | 2444 | Clone in performance-critical code — consider references |
| HIGH | ? | context.rs | 2453 | Clone in performance-critical code — consider references |
| HIGH | ? | context.rs | 2460 | Clone in performance-critical code — consider references |
| HIGH | ? | context.rs | 2466 | Clone in performance-critical code — consider references |
| HIGH | ? | context.rs | 2473 | Clone in performance-critical code — consider references |
| HIGH | ? | context.rs | 2480 | Clone in performance-critical code — consider references |
| HIGH | ? | context.rs | 2481 | Clone in performance-critical code — consider references |
| HIGH | ? | context.rs | 2506 | Clone in performance-critical code — consider references |
| HIGH | ? | context.rs | 2509 | Clone in performance-critical code — consider references |
| HIGH | ? | context.rs | 2525 | Clone in performance-critical code — consider references |
| HIGH | ? | context.rs | 2528 | Clone in performance-critical code — consider references |
| HIGH | ? | context.rs | 2529 | Clone in performance-critical code — consider references |
| HIGH | ? | context.rs | 2558 | Clone in performance-critical code — consider references |
| HIGH | ? | context.rs | 2560 | Clone in performance-critical code — consider references |
| HIGH | ? | context.rs | 2565 | Clone in performance-critical code — consider references |
| HIGH | ? | context.rs | 2567 | Clone in performance-critical code — consider references |
| HIGH | ? | context.rs | 2576 | Clone in performance-critical code — consider references |
| HIGH | ? | context.rs | 2578 | Clone in performance-critical code — consider references |
| HIGH | ? | context.rs | 2581 | Clone in performance-critical code — consider references |
| HIGH | ? | context.rs | 2591 | Clone in performance-critical code — consider references |
| HIGH | ? | context.rs | 2601 | Clone in performance-critical code — consider references |
| HIGH | ? | context.rs | 2736 | Clone in performance-critical code — consider references |
| HIGH | ? | context.rs | 2739 | Clone in performance-critical code — consider references |
| HIGH | ? | context.rs | 2797 | Clone in performance-critical code — consider references |
| HIGH | ? | context.rs | 2821 | Clone in performance-critical code — consider references |
| HIGH | ? | context.rs | 2867 | Clone in performance-critical code — consider references |
| HIGH | ? | context.rs | 2877 | Clone in performance-critical code — consider references |
| HIGH | ? | context.rs | 2881 | Clone in performance-critical code — consider references |
| HIGH | ? | context.rs | 2886 | Clone in performance-critical code — consider references |
| HIGH | ? | context.rs | 2903 | Clone in performance-critical code — consider references |
| HIGH | ? | context.rs | 2905 | Clone in performance-critical code — consider references |
| HIGH | ? | context.rs | 2921 | Clone in performance-critical code — consider references |
| HIGH | ? | context.rs | 3119 | Clone in performance-critical code — consider references |
| HIGH | ? | context.rs | 3123 | Clone in performance-critical code — consider references |
| HIGH | ? | context.rs | 3206 | Clone in performance-critical code — consider references |
| HIGH | ? | context.rs | 3213 | Clone in performance-critical code — consider references |
| HIGH | ? | context.rs | 3218 | Clone in performance-critical code — consider references |
| HIGH | ? | context.rs | 3299 | Clone in performance-critical code — consider references |
| HIGH | ? | context.rs | 3301 | Clone in performance-critical code — consider references |
...
| HIGH | ? | subquery.rs | 219 | Clone in performance-critical code — consider references |
| HIGH | ? | subquery.rs | 252 | Clone in performance-critical code — consider references |
...
| HIGH | ? | sql_expr.rs | 111 | Clone in performance-critical code — consider references |
| HIGH | ? | sql_expr.rs | 263 | Clone in performance-critical code — consider references |
| HIGH | ? | sql_expr.rs | 279 | Clone in performance-critical code — consider references |
| HIGH | ? | sql_expr.rs | 378 | Clone in performance-critical code — consider references |
| HIGH | ? | sql_expr.rs | 379 | Clone in performance-critical code — consider references |
| HIGH | ? | sql_expr.rs | 397 | Clone in performance-critical code — consider references |
| HIGH | ? | sql_expr.rs | 409 | Clone in performance-critical code — consider references |
| HIGH | ? | sql_expr.rs | 468 | Clone in performance-critical code — consider references |
| HIGH | ? | sql_expr.rs | 474 | Clone in performance-critical code — consider references |
| HIGH | ? | sql_expr.rs | 481 | Clone in performance-critical code — consider references |
| HIGH | ? | sql_expr.rs | 493 | Clone in performance-critical code — consider references |
| HIGH | ? | sql_expr.rs | 499 | Clone in performance-critical code — consider references |
| HIGH | ? | sql_expr.rs | 514 | Clone in performance-critical code — consider references |
| HIGH | ? | sql_expr.rs | 522 | Clone in performance-critical code — consider references |
| HIGH | ? | sql_expr.rs | 526 | Clone in performance-critical code — consider references |
| HIGH | ? | sql_expr.rs | 543 | Clone in performance-critical code — consider references |
| HIGH | ? | sql_expr.rs | 693 | Clone in performance-critical code — consider references |
| HIGH | ? | sql_expr.rs | 694 | Clone in performance-critical code — consider references |
| HIGH | ? | sql_expr.rs | 701 | Clone in performance-critical code — consider references |
| HIGH | ? | sql_expr.rs | 702 | Clone in performance-critical code — consider references |
| HIGH | ? | sql_expr.rs | 764 | Clone in performance-critical code — consider references |
| HIGH | ? | sql_expr.rs | 936 | Clone in performance-critical code — consider references |
| HIGH | ? | sql_expr.rs | 942 | Clone in performance-critical code — consider references |
| HIGH | ? | sql_expr.rs | 961 | Clone in performance-critical code — consider references |
| HIGH | ? | sql_expr.rs | 976 | Clone in performance-critical code — consider references |
| HIGH | ? | sql_expr.rs | 983 | Clone in performance-critical code — consider references |
| HIGH | ? | sql_expr.rs | 1075 | Clone in performance-critical code — consider references |
| HIGH | ? | sql_expr.rs | 1077 | Clone in performance-critical code — consider references |
| HIGH | ? | sql_expr.rs | 1134 | Clone in performance-critical code — consider references |
| HIGH | ? | sql_expr.rs | 1153 | Clone in performance-critical code — consider references |
| HIGH | ? | sql_expr.rs | 1154 | Clone in performance-critical code — consider references |
| HIGH | ? | sql_expr.rs | 1156 | Clone in performance-critical code — consider references |
| HIGH | ? | sql_expr.rs | 1450 | Clone in performance-critical code — consider references |
| HIGH | ? | sql_expr.rs | 1460 | Clone in performance-critical code — consider references |
| HIGH | ? | sql_expr.rs | 1464 | Clone in performance-critical code — consider references |
| HIGH | ? | sql_expr.rs | 1468 | Clone in performance-critical code — consider references |
| HIGH | ? | sql_expr.rs | 1474 | Clone in performance-critical code — consider references |
| HIGH | ? | sql_expr.rs | 1502 | Clone in performance-critical code — consider references |
| HIGH | ? | sql_expr.rs | 1503 | Clone in performance-critical code — consider references |
| HIGH | ? | sql_expr.rs | 1505 | Clone in performance-critical code — consider references |
| HIGH | ? | sql_expr.rs | 1507 | Clone in performance-critical code — consider references |
| HIGH | ? | sql_expr.rs | 1509 | Clone in performance-critical code — consider references |
| HIGH | ? | sql_expr.rs | 1561 | Clone in performance-critical code — consider references |
| HIGH | ? | sql_expr.rs | 1626 | Clone in performance-critical code — consider references |
| HIGH | ? | functions.rs | 1234 | Clone in performance-critical code — consider references |
| HIGH | ? | functions.rs | 1323 | Clone in performance-critical code — consider references |
| HIGH | ? | functions.rs | 1330 | Clone in performance-critical code — consider references |
| HIGH | ? | functions.rs | 1331 | Clone in performance-critical code — consider references |
| HIGH | ? | functions.rs | 1332 | Clone in performance-critical code — consider references |
| HIGH | ? | functions.rs | 1334 | Clone in performance-critical code — consider references |
| HIGH | ? | functions.rs | 1344 | Clone in performance-critical code — consider references |
| HIGH | ? | functions.rs | 1346 | Clone in performance-critical code — consider references |
| HIGH | ? | functions.rs | 1408 | Clone in performance-critical code — consider references |
| HIGH | ? | functions.rs | 1466 | Clone in performance-critical code — consider references |
| HIGH | ? | functions.rs | 1473 | Clone in performance-critical code — consider references |
| HIGH | ? | functions.rs | 1475 | Clone in performance-critical code — consider references |
| HIGH | ? | functions.rs | 1477 | Clone in performance-critical code — consider references |
| HIGH | ? | functions.rs | 1479 | Clone in performance-critical code — consider references |
| HIGH | ? | functions.rs | 1480 | Clone in performance-critical code — consider references |
| HIGH | ? | functions.rs | 1490 | Clone in performance-critical code — consider references |
| HIGH | ? | functions.rs | 1492 | Clone in performance-critical code — consider references |
| HIGH | ? | functions.rs | 1568 | Clone in performance-critical code — consider references |
| HIGH | ? | functions.rs | 1572 | Clone in performance-critical code — consider references |
| HIGH | ? | functions.rs | 1587 | Clone in performance-critical code — consider references |
| HIGH | ? | functions.rs | 1588 | Clone in performance-critical code — consider references |
| HIGH | ? | functions.rs | 1757 | Clone in performance-critical code — consider references |
| HIGH | ? | functions.rs | 1982 | Clone in performance-critical code — consider references |
| HIGH | ? | functions.rs | 2006 | Clone in performance-critical code — consider references |
| HIGH | ? | functions.rs | 2291 | Clone in performance-critical code — consider references |
| HIGH | ? | functions.rs | 2309 | Clone in performance-critical code — consider references |
| HIGH | ? | functions.rs | 2484 | Clone in performance-critical code — consider references |
| HIGH | ? | functions.rs | 2549 | Clone in performance-critical code — consider references |
...
| HIGH | ? | frame.py | 4799 | Clone in performance-critical code — consider references |
| HIGH | ? | frame.py | 5057 | Clone in performance-critical code — consider references |
| HIGH | ? | frame.py | 5215 | Clone in performance-critical code — consider references |
...
| L | GS003 | scans.rs | 1135 |
| L | GS003 | scans.rs | 1179 |
| L | GS003 | scans.rs | 1218 |
| L | GS003 | scans.rs | 1255 |
| L | GS003 | scans.rs | 1446 |
| L | GS003 | debug.rs | 7 |
| L | GS003 | debug.rs | 10 |
| L | GS003 | debug.rs | 12 |
...
| L | GS003 | csee.rs | 832 |
| L | GS003 | expand_datasets.rs | 222 |
| L | GS003 | expand_datasets.rs | 500 |
| L | GS003 | mod.rs | 150 |
| L | GS003 | build.rs | 2 |
| L | GS003 | build.rs | 5 |
...
| L | GS003 | equi_join.rs | 323 |
| L | GS003 | equi_join.rs | 343 |
| L | GS003 | equi_join.rs | 377 |
...
| H | ? | semi_anti_join.rs | 182 |
| H | ? | semi_anti_join.rs | 183 |
| H | ? | semi_anti_join.rs | 305 |
| H | ? | semi_anti_join.rs | 322 |
| H | ? | semi_anti_join.rs | 435 |
| H | ? | semi_anti_join.rs | 455 |
| H | ? | asof_join.rs | 306 |
| H | ? | asof_join.rs | 346 |
| H | ? | asof_join.rs | 377 |
| H | ? | asof_join.rs | 381 |
...
| H | ? | lower_expr.rs | 2491 |
| H | ? | lower_expr.rs | 2497 |
| H | ? | lower_expr.rs | 2533 |
| H | ? | lower_expr.rs | 2540 |
| H | ? | lower_expr.rs | 2545 |
| H | ? | lower_expr.rs | 2546 |
| H | ? | lower_expr.rs | 2557 |
| H | ? | lower_expr.rs | 2566 |
| H | ? | lower_expr.rs | 2567 |
| H | ? | lower_expr.rs | 2581 |
| H | ? | lower_expr.rs | 2603 |
| H | ? | lower_expr.rs | 2630 |
| H | ? | lower_expr.rs | 2639 |
| H | ? | lower_expr.rs | 2643 |
| H | ? | lower_expr.rs | 2653 |
| H | ? | lower_expr.rs | 2663 |
| H | ? | lower_expr.rs | 2709 |
| H | ? | lower_expr.rs | 2712 |
| H | ? | lower_expr.rs | 2750 |
| H | ? | lower_expr.rs | 2756 |
| H | ? | lower_expr.rs | 2779 |
| H | ? | lower_expr.rs | 2819 |
| H | ? | lower_expr.rs | 2860 |
| H | ? | lower_expr.rs | 2863 |
| H | ? | lower_expr.rs | 2865 |
| H | ? | lower_expr.rs | 2885 |
| H | ? | lower_expr.rs | 2886 |
| H | ? | lower_expr.rs | 2888 |
| H | ? | lower_expr.rs | 2893 |
| H | ? | lower_expr.rs | 2938 |
...
| H | ? | scan_sources.rs | 88 |
| H | ? | scan_sources.rs | 97 |
| H | ? | scan_sources.rs | 201 |
| H | ? | scan_sources.rs | 237 |
| H | ? | scan_sources.rs | 264 |
| H | ? | scan_sources.rs | 357 |
| H | ? | scan_sources.rs | 358 |
| H | ? | scan_sources.rs | 377 |
| H | ? | scan_sources.rs | 385 |
| H | ? | scan_sources.rs | 417 |
| H | ? | scan_sources.rs | 429 |
| H | ? | scan_sources.rs | 454 |
| H | ? | scan_sources.rs | 490 |
| H | ? | scan_sources.rs | 503 |
| H | ? | scan_sources.rs | 509 |
| H | ? | meta.rs | 33 |
| H | ? | mod.rs | 450 |
| H | ? | mod.rs | 854 |
| H | ? | serde_expr.rs | 43 |
...
| H | ? | expand_datasets.rs | 66 |
| H | ? | expand_datasets.rs | 78 |
| H | ? | expand_datasets.rs | 218 |
| H | ? | expand_datasets.rs | 325 |
| H | ? | expand_datasets.rs | 328 |
| H | ? | expand_datasets.rs | 331 |
| H | ? | expand_datasets.rs | 332 |
| H | ? | expand_datasets.rs | 333 |
| H | ? | expand_datasets.rs | 334 |
| H | ? | expand_datasets.rs | 369 |
| H | ? | expand_datasets.rs | 371 |
| H | ? | expand_datasets.rs | 422 |
| H | ? | expand_datasets.rs | 440 |
| H | ? | expand_datasets.rs | 441 |
| H | ? | mod.rs | 162 |
| H | ? | mod.rs | 264 |
| H | ? | mod.rs | 270 |
| H | ? | mod.rs | 361 |
...
| H | ? | mod.rs | 538 |
| H | ? | mod.rs | 562 |
| H | ? | predicate_pruning.rs | 253 |
| H | ? | predicate_pruning.rs | 300 |
| H | ? | predicate_pruning.rs | 550 |
| H | ? | predicate_pruning.rs | 619 |
| H | ? | predicate_pruning.rs | 646 |
| H | ? | predicate_pruning.rs | 711 |
| H | ? | predicate_pruning.rs | 714 |
| H | ? | predicate_pruning.rs | 715 |
| H | ? | predicate_pruning.rs | 717 |
| H | ? | predicate_pruning.rs | 724 |
| H | ? | predicate_pruning.rs | 725 |
| H | ? | predicate_pruning.rs | 740 |
| H | ? | predicate_pruning.rs | 746 |
| H | ? | predicate_pruning.rs | 751 |
| H | ? | predicate_pruning.rs | 758 |
| H | ? | predicate_pruning.rs | 759 |
| H | ? | predicate_pruning.rs | 764 |
| H | ? | predicate_pruning.rs | 844 |
| H | ? | predicate_pruning.rs | 847 |
| H | ? | predicate_pruning.rs | 848 |
| H | ? | predicate_pruning.rs | 853 |
| H | ? | predicate_pruning.rs | 861 |
| H | ? | predicate_pruning.rs | 862 |
| H | ? | predicate_pruning.rs | 864 |
| H | ? | predicate_pruning.rs | 867 |
| H | ? | predicate_pruning.rs | 874 |
| H | ? | predicate_pruning.rs | 876 |
| H | ? | predicate_pruning.rs | 896 |
| H | ? | predicate_pruning.rs | 901 |
| H | ? | predicate_pruning.rs | 910 |
| H | ? | hive.rs | 11 |
| H | ? | hive.rs | 79 |
| H | ? | hive.rs | 90 |
| H | ? | hive.rs | 96 |
...
| H | ? | simplify_functions.rs | 227 |
| H | ? | simplify_functions.rs | 237 |
| H | ? | simplify_functions.rs | 348 |
...
| H | ? | file_metadata.rs | 141 |
| H | ? | file_metadata.rs | 171 |
...
| H | ? | writer.rs | 224 |
| H | ? | options.rs | 115 |
| H | ? | schema_inference.rs | 206 |
| H | ? | schema_inference.rs | 220 |
| H | ? | schema_inference.rs | 234 |
| H | ? | parser.rs | 133 |
| H | ? | read_impl.rs | 76 |
| H | ? | read_impl.rs | 193 |
| H | ? | read_impl.rs | 198 |
...
---
*Сгенерировано GSC v0.6 · 2026-07-19T04:07:29.219637*