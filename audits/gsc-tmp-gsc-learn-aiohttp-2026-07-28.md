...
**Дата:** 28.07.2026 04:02  
**Путь:** `/tmp/gsc-learn/aiohttp`  
**Всего находок:** 436  
**CRITICAL:** 0 | **HIGH:** 7 | **MEDIUM:** 157 | **LOW:** 271

## 📊 По детекторам

| Детектор | Находок |
|----------|--------|
| Python: assert in production | 152 |
| GS003 | 19 |
| GS008 | 15 |
...
|-----------|--------|------|--------|--------|
| HIGH | ? | web_runner.py | 170 | Match:         host = "0.0.0.0" if not self._host else self. |
...
| M | ? | client_reqrep.py | 1278 |
| M | ? | client_reqrep.py | 1490 |
...
| M | ? | http_parser.py | 534 |
| M | ? | http_parser.py | 535 |
| M | ? | http_parser.py | 1202 |
| M | ? | client.py | 233 |
| M | ? | client.py | 239 |
| M | ? | client.py | 332 |
| M | ? | client.py | 535 |
...
| M | ? | multipart.py | 1149 |
| M | ? | multipart.py | 1239 |
| M | ? | web_request.py | 479 |
| M | ? | web_request.py | 892 |
| M | ? | web_request.py | 899 |
| M | ? | web_request.py | 905 |
| M | ? | web_request.py | 914 |
| M | ? | web_fileresponse.py | 129 |
| M | ? | web_fileresponse.py | 282 |
| M | ? | web_fileresponse.py | 402 |
| M | ? | streams.py | 253 |
| M | ? | streams.py | 286 |
| M | ? | streams.py | 372 |
| M | ? | streams.py | 731 |
...
| M | ? | web_response.py | 321 |
| M | ? | web_response.py | 322 |
| M | ? | web_response.py | 333 |
| M | ? | web_response.py | 374 |
| M | ? | web_response.py | 376 |
| M | ? | web_response.py | 437 |
| M | ? | web_response.py | 439 |
| M | ? | web_response.py | 452 |
| M | ? | web_response.py | 464 |
| M | ? | web_response.py | 465 |
| M | ? | web_response.py | 474 |
| M | ? | web_response.py | 481 |
| M | ? | web_response.py | 493 |
| M | ? | web_response.py | 647 |
| M | ? | web_response.py | 687 |
| M | ? | web_response.py | 688 |
| M | ? | web_response.py | 689 |
| M | ? | web_response.py | 731 |
...
---
*Сгенерировано GSC v0.6 · 2026-07-28T04:02:12.249419*