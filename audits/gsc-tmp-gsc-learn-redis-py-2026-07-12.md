...
**Дата:** 12.07.2026 04:01  
**Путь:** `/tmp/gsc-learn/redis-py`  
**Всего находок:** 133  
**CRITICAL:** 0 | **HIGH:** 14 | **MEDIUM:** 13 | **LOW:** 105
...
| HIGH | ? | core.py | 10918 | Match:     def eval( |
| HIGH | ? | core.py | 10926 | Match:     def eval( |
| HIGH | ? | core.py | 10933 | Match:     def eval( |
...
---
*Сгенерировано GSC v0.6 · 2026-07-12T04:01:35.620852*