...
**Дата:** 04.08.2026 22:29  
**Путь:** `/home/openclaw/gsc`  
**Всего находок:** 720  
**CRITICAL:** 186 | **HIGH:** 77 | **MEDIUM:** 62 | **LOW:** 359
...
| CRITICAL | ? | gs020_llm_sqli.py | 114 | OWASP A03: Injection |
| CRITICAL | ? | gs020_llm_sqli.py | 213 | OWASP A03: Injection |
...
| CRITICAL | ? | gs020_llm_sqli.py | 114 |  |
| CRITICAL | ? | gs020_llm_sqli.py | 213 |  |
...
| CRITICAL | GS001 | registry.py | 202 | Found: "GS024" |
...
| CRITICAL | GS005 | gs020_llm_sqli.py | 114 | Line 114: - f-string with user-controlled input: cursor.exec |
| CRITICAL | GS005 | gs020_llm_sqli.py | 213 | Line 213: cursor.execute(f"SELECT * FROM users WHERE id = {u |
...
| C | ? | gs020_llm_sqli.py | 114 |
| C | ? | gs020_llm_sqli.py | 213 |
| M | ? | pre-commit | 22 |
| M | ? | gsc_doctor.py | 16 |
| M | ? | gsc_doctor.py | 33 |
...
| L | GS008 | registry.py | 216 |
| L | GS008 | registry.py | 217 |
| i | GS020 |  | 6 |
| i | GS020 |  | 30 |
| i | GS020 |  | 30 |
| i | GS020 |  | 32 |
...
| C | GS005 | gs020_llm_sqli.py | 114 |
| C | GS005 | gs020_llm_sqli.py | 213 |
...
---
*Сгенерировано GSC v0.6 · 2026-08-04T22:29:46.038187*