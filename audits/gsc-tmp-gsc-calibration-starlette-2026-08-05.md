---
title: "GSC Audit: /tmp/gsc-calibration/starlette"
date: 2026-08-05
tags: [gsc, audit, security]
---

# 🔒 GSC Audit — /tmp/gsc-calibration/starlette

**Дата:** 05.08.2026 07:49  
**Путь:** `/tmp/gsc-calibration/starlette`  
**Всего находок:** 170  
**CRITICAL:** 2 | **HIGH:** 10 | **MEDIUM:** 77 | **LOW:** 59

## 📊 По детекторам

| Детектор | Находок |
|----------|--------|
| Python: assert in production | 73 |
| GS022 | 17 |
| Хардкод IP адреса | 5 |
...
| L | ? | exceptions.py | 26 |
| L | ? | exceptions.py | 26 |
| M | ? | gzip_benchmark.py | 127 |
| M | ? | gzip_benchmark.py | 183 |
| M | ? | gzip_benchmark.py | 184 |
| M | ? | gzip_benchmark.py | 185 |
| M | ? | gzip_benchmark.py | 186 |
| M | ? | gzip_benchmark.py | 188 |
| M | ? | gzip_benchmark.py | 190 |
| M | ? | gzip_benchmark.py | 218 |
| M | ? | routing.py | 133 |
| M | ? | routing.py | 207 |
| M | ? | routing.py | 264 |
| M | ? | routing.py | 302 |
...
---
*Сгенерировано GSC v0.6 · 2026-08-05T07:49:30.365248*