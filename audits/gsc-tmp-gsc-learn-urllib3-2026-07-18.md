...
| HIGH | ? | uv.lock | 2369 | Match: version = "1.7.1.20251001" |
| HIGH | ? | uv.lock | 2371 | Match: sdist = { url = "https://files.pythonhosted.org/packa |
| HIGH | ? | uv.lock | 2373 | Match:     { url = "https://files.pythonhosted.org/packages/ |
| HIGH | ? | uv.lock | 2378 | Match: version = "2.33.0.20260408" |
| HIGH | ? | uv.lock | 2383 | Match: sdist = { url = "https://files.pythonhosted.org/packa |
| HIGH | ? | uv.lock | 2385 | Match:     { url = "https://files.pythonhosted.org/packages/ |
| HIGH | ? | uv.lock | 2540 | Match:     { name = "brotlicffi", marker = "platform_python_ |
| HIGH | ? | uv.lock | 2637 | Match:     { name = "types-pysocks", specifier = ">=1.7.1.20 |
| HIGH | ? | uv.lock | 2638 | Match:     { name = "types-requests", specifier = ">=2.32.0. |
...
---
*Сгенерировано GSC v0.6 · 2026-07-18T04:00:20.149863*