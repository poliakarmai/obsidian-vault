...
**Дата:** 29.06.2026 20:25  
**Путь:** `/home/openclaw/bybit-ws`  
**Всего находок:** 613  
**CRITICAL:** 3 | **HIGH:** 59 | **MEDIUM:** 19 | **LOW:** 529
...
| GS003 | 479 |
| GS008 | 39 |
| env vars разбросаны по коду | 30 |
...
| HIGH | ? | paper_trading.py | 18 | Feature flags должны быть в едином модуле feature_flags.py |
| HIGH | ? | heavy_cycle_opt.py | 80 | Feature flags должны быть в едином модуле feature_flags.py |
...
| HIGH | ? | entry_judge.py | 17 | Feature flags должны быть в едином модуле feature_flags.py |
...
| HIGH | ? | sl_reentry.py | 112 | Feature flags должны быть в едином модуле feature_flags.py |
| HIGH | ? | auto_tp.py | 28 | Feature flags должны быть в едином модуле feature_flags.py |
...
| HIGH | ? | main_async.py | 413 | Feature flags должны быть в едином модуле feature_flags.py |
| HIGH | ? | main_async.py | 467 | Feature flags должны быть в едином модуле feature_flags.py |
| HIGH | ? | auto_sl.py | 18 | Feature flags должны быть в едином модуле feature_flags.py |
...
| HIGH | ? | main_async.py | 514 | Match:         ws_push_thread = start_ws_server(port=8767, b |
| HIGH | ? | main_async.py | 515 | Match:         log_event('📡 WebSocket push server on 127.0.0 |
...
| H | ? | paper_trading.py | 18 |
| H | ? | heavy_cycle_opt.py | 80 |
| H | ? | trailing_sl.py | 9 |
...
| L | GS003 | main_async.py | 418 |
| L | GS003 | main_async.py | 473 |
...
| L | GS003 | push_notifier.py | 187 |
| L | GS003 | push_notifier.py | 193 |
| L | GS003 | push_notifier.py | 196 |
| L | GS003 | push_notifier.py | 199 |
| L | GS003 | push_notifier.py | 287 |
| L | GS003 | push_notifier.py | 290 |
...
| L | GS003 | scan_unpack.py | 95 |
| L | GS003 | scan_unpack.py | 99 |
| L | GS003 | scan_unpack.py | 101 |
...
---
*Сгенерировано GSC v0.6 · 2026-06-29T20:25:16.904190*