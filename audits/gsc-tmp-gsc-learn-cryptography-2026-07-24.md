...
**Дата:** 24.07.2026 04:06  
**Путь:** `/tmp/gsc-learn/cryptography`  
**Всего находок:** 2260  
**CRITICAL:** 3 | **HIGH:** 1796 | **MEDIUM:** 328 | **LOW:** 132
...
|----------|--------|
| GS002 | 1146 |
| Хардкод IP адреса | 440 |
| GS014 | 305 |
| Rust: .clone() in hot path | 207 |
| GS008 | 94 |
| GS003 | 38 |
...
|-----------|--------|------|--------|--------|
| CRITICAL | GS001 | _oid.py | 370 | Found: PASSWORD: "challengePassword" |
...
| HIGH | ? | _oid.py | 199 | Match:     SERVER_AUTH = ObjectIdentifier("1.3.6.1.5.5.7.3.1 |
| HIGH | ? | _oid.py | 200 | Match:     CLIENT_AUTH = ObjectIdentifier("1.3.6.1.5.5.7.3.2 |
| HIGH | ? | _oid.py | 201 | Match:     CODE_SIGNING = ObjectIdentifier("1.3.6.1.5.5.7.3. |
| HIGH | ? | _oid.py | 202 | Match:     EMAIL_PROTECTION = ObjectIdentifier("1.3.6.1.5.5. |
| HIGH | ? | _oid.py | 203 | Match:     TIME_STAMPING = ObjectIdentifier("1.3.6.1.5.5.7.3 |
| HIGH | ? | _oid.py | 204 | Match:     OCSP_SIGNING = ObjectIdentifier("1.3.6.1.5.5.7.3. |
| HIGH | ? | _oid.py | 205 | Match:     ANY_EXTENDED_KEY_USAGE = ObjectIdentifier("2.5.29 |
| HIGH | ? | _oid.py | 206 | Match:     SMARTCARD_LOGON = ObjectIdentifier("1.3.6.1.4.1.3 |
| HIGH | ? | _oid.py | 207 | Match:     KERBEROS_PKINIT_KDC = ObjectIdentifier("1.3.6.1.5 |
| HIGH | ? | _oid.py | 208 | Match:     IPSEC_IKE = ObjectIdentifier("1.3.6.1.5.5.7.3.17" |
| HIGH | ? | _oid.py | 209 | Match:     BUNDLE_SECURITY = ObjectIdentifier("1.3.6.1.5.5.7 |
| HIGH | ? | _oid.py | 210 | Match:     CERTIFICATE_TRANSPARENCY = ObjectIdentifier("1.3. |
| HIGH | ? | _oid.py | 214 | Match:     PERMANENT_IDENTIFIER = ObjectIdentifier("1.3.6.1. |
| HIGH | ? | _oid.py | 215 | Match:     HW_MODULE_NAME = ObjectIdentifier("1.3.6.1.5.5.7. |
| HIGH | ? | _oid.py | 216 | Match:     DNS_SRV = ObjectIdentifier("1.3.6.1.5.5.7.8.7") |
| HIGH | ? | _oid.py | 217 | Match:     NAI_REALM = ObjectIdentifier("1.3.6.1.5.5.7.8.8") |
| HIGH | ? | _oid.py | 218 | Match:     SMTP_UTF8_MAILBOX = ObjectIdentifier("1.3.6.1.5.5 |
| HIGH | ? | _oid.py | 219 | Match:     ACP_NODE_NAME = ObjectIdentifier("1.3.6.1.5.5.7.8 |
| HIGH | ? | _oid.py | 220 | Match:     BUNDLE_EID = ObjectIdentifier("1.3.6.1.5.5.7.8.11 |
| HIGH | ? | _oid.py | 224 | Match:     CA_ISSUERS = ObjectIdentifier("1.3.6.1.5.5.7.48.2 |
| HIGH | ? | _oid.py | 225 | Match:     OCSP = ObjectIdentifier("1.3.6.1.5.5.7.48.1") |
| HIGH | ? | _oid.py | 229 | Match:     CA_REPOSITORY = ObjectIdentifier("1.3.6.1.5.5.7.4 |
| HIGH | ? | _oid.py | 233 | Match:     CPS_QUALIFIER = ObjectIdentifier("1.3.6.1.5.5.7.2 |
| HIGH | ? | _oid.py | 234 | Match:     CPS_USER_NOTICE = ObjectIdentifier("1.3.6.1.5.5.7 |
| HIGH | ? | _oid.py | 235 | Match:     ANY_POLICY = ObjectIdentifier("2.5.29.32.0") |
| HIGH | ? | _oid.py | 239 | Match:     CHALLENGE_PASSWORD = ObjectIdentifier("1.2.840.11 |
| HIGH | ? | _oid.py | 240 | Match:     UNSTRUCTURED_NAME = ObjectIdentifier("1.2.840.113 |
...
| HIGH | ? | mod.rs | 747 | Match:         let ip_sub = Subject::IP(IPAddress::from_str( |
...
| HIGH | ? | mod.rs | 819 | Clone in performance-critical code — consider references |
...
| HIGH | ? | ciphers.rs | 582 | Clone in performance-critical code — consider references |
| HIGH | ? | ciphers.rs | 615 | Clone in performance-critical code — consider references |
...
---
*Сгенерировано GSC v0.6 · 2026-07-24T04:06:18.919868*